...
### 6.1 相关模型
- [[diode-model]] - 反并联二极管
- [[vsc-model]] - IGBT在换流器中的应用
- [[mmc-model]] - 多电平换流器
- [[transformer-model]] - 隔离驱动

### 6.2 相关方法
- [[average-value-model]] - 系统级仿真
- 热建模 - 温度相关特性
...
- [[diode-model]] - 反并联续流二极管
- [[vsc-model]] - IGBT在换流器中的应用
- [[mmc-model]] - 多电平换流器
- [[average-value-model]] - 系统级仿真简化
...
| 论文 | 年份 |
|------|------|
| [[an-improved-high-accuracy-interpolation-method-for-switching-devices-in-emt-simu]] | 2023 |
| [[parallelization-of-mmc-detailed-equivalent-model]] | 2021 |
| [[real-time-mpsoc-based-electrothermal-transient-simulation-of-fault-tolerant-mmc-]] | 2019 |
| [[hierarchical-device-level-modular-multilevel-converter-modeling-for-parallel-and]] | 2020 |
| [[supplementary-techniques-for-2s-dirk-based-emt-simulations]] | 2014 |
| [[comparison-of-the-atp-version-of-the-emtp-and-the-netomac-program-for-simulation]] | 2004 |
