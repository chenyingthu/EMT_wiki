...
—Previously, a method for identifying a multiphase net- work equivalent for electromagnetic transient calculations using partitioned frequency response has been proposed
