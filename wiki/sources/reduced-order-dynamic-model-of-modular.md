...
— A reduced-order dynamic phasor model of modular multilevel converter (MMC) in long time-scale which is applied for power system low-frequency oscillation analysis is investigated
