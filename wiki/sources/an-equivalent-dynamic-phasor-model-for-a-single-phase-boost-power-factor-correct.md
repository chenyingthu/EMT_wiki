...
To mitigate harmonic current ﬂow in distribution systems, single-phase diode-bridge rectiﬁers (DBRs) are commonly equipped with active power factor correction (PFC) controllers
