...
- [[模态变换|模态变换]]
- [[相域分析|相域分析]]
- [[基于单端电气量测量的参数推导方法|基于单端电气量测量的参数推导方法]]
...
—The objective of this paper is to show an alternative methodology to calculate transmission-line parameters per unit length
