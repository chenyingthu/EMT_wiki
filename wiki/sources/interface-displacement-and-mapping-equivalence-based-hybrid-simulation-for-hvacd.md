...
- [[电磁暂态与机电暂态混合仿真|电磁暂态与机电暂态混合仿真]]
- [[接口位移技术-id|接口位移技术(ID)]]
- [[动态相量映射等效-dp-me|动态相量映射等效(DP-ME)]]
- [[动态相量法|动态相量法]]
- [[接口延迟量化分析|接口延迟量化分析]]
- [[子网松耦合技术|子网松耦合技术]]
...
- [[hvac-dc交直流电网|HVAC/DC交直流电网]]
- [[换流器|换流器]]
- [[动态相量映射等效模型|动态相量映射等效模型]]
- [[控制回路模型|控制回路模型]]
- [[戴维南-诺顿等效模型|戴维南/诺顿等效模型]]
...
—In the electromagnetic transient (EMT) and transient stability (TS) hybrid simulation, the entire power system is artificially split into two sub-grids, and sub-grids interact with each other via an 
