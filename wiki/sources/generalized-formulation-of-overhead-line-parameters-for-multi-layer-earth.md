...
- [[矩量法-表面导纳算子法-mom-so|矩量法-表面导纳算子法(MoM-SO)]]
- [[修正大地返回格林函数法|修正大地返回格林函数法]]
- [[广义参数公式推导|广义参数公式推导]]
- [[电磁暂态仿真|电磁暂态仿真]]
...
—A generalized formulation of earth-return impedance and admittance for overhead lines above a multi-layer earth is derived
