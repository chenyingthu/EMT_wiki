...
- 提出了一种面向新能源电力系统的组件级精细化建模架构
- 开发了适用于电磁暂态(EMT)研究的细粒度仿真求解方法
- 实现了高比例新能源系统多时间尺度动态的准确高效仿真

## 使用的方法

- [[组件级等效与接口建模|组件级等效与接口建模]]
- [[细粒度自适应时间步长算法|细粒度自适应时间步长算法]]
- [[电力电子开关级与平均值混合仿真|电力电子开关级与平均值混合仿真]]
- [[并行计算与模型降阶技术|并行计算与模型降阶技术]]
...
- 组件级建模有效保留了新能源设备内部控制与电气动态特性
- 细粒度仿真方法在维持EMT级精度的同时显著提升了大规模系统计算效率
- 该方法可准确揭示新能源集群间的电磁暂态交互机理与故障穿越特性
