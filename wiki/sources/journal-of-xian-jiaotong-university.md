...
：Based on the T-form equivalent circuita transformer model that accounts for turn ratiointer- phase coupleconnectionphase thiftetc．is presented．The main functions are compared separately with EMT
