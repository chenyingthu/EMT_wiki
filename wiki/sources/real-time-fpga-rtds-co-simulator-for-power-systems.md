...
—This paper proposes a co-simulation platform using Field-Programmable Gate Array (FPGA) and Real-Time Digital Simulator (RTDS) for the simulation of large power systems
