...
- [[仿真模式切换|仿真模式切换]]
- [[相量域建模-正序-三序-三相-混合表示|相量域建模（正序/三序/三相/混合表示）]]
- [[网络等值|网络等值]]
- [[动态相量法|动态相量法]]
...
—Conventional electromagnetic transient (EMT) and phasor-domain hybrid simulation approaches presently exist for transmission system level studies
