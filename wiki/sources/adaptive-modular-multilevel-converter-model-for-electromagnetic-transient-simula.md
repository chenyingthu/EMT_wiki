...
- [[模型切换技术|模型切换技术]]
- [[时域初始化方法|时域初始化方法]]
- [[戴维南-诺顿等效接口|戴维南/诺顿等效接口]]
- [[igbt双值电阻建模|IGBT双值电阻建模]]
- [[平滑过渡算法|平滑过渡算法]]
...
- [[多精度仿真|多精度仿真]]
- [[高压直流输电仿真|高压直流输电仿真]]
- [[仿真精度与计算效率权衡|仿真精度与计算效率权衡]]

## 主要发现

—This paper proposes an adaptive model of modular multilevel converter (MMC) for electromagnetic transient (EMT) simulations
