...
代表性来源包括 [[large-scale-hybrid-real-time-simulation-modeling-and-benchmark-for-nelson-river-|Large-scale hybrid real-time simulation modeling and benchmark for Nelson River]]、[[real-time-digital-simulator-of-the-electromagnetic-transients-of-power-transmiss|Real-time digital simulator of electromagnetic transients of power transmission]]、[[development-of-phase-domain-frequency-dependent-transmission-line-model-on-fpga-|Development of phase-domain frequency-dependent transmission line model on FPGA]] 和 [[a-flux-defined-pmsm-model-based-on-fea-results-for-real-time-emt-simulation|A Flux-Defined PMSM Model Based on FEA Results for Real-Time EMT Simulation]]。相关实体包括 [[manitoba-hydro]]、[[gole]] 和 [[pscad-emtdc]]。

## 相关方法
- [[vector-fitting|矢量拟合]] - FDNE频率相关网络等值用于混合仿真边界建模
- [[state-space-method|状态空间法]] - 用于电力电子设备快速求解与模型降阶
- [[numerical-integration|数值积分]] - 固定步长梯形积分保证实时确定性计算
- [[multirate-method|多速率方法]] - EMT-RMS跨平台联合仿真的步长协调策略

## 相关模型
- [[fdne-model|FDNE模型]] - 频率相关网络等值用于大规模系统降阶和边界等值
- [[pmsm-model|PMSM模型]] - 永磁同步电机磁链定义模型用于亚微秒级仿真
- [[vsc-model|VSC模型]] - 电压源换流器实时仿真模型和等效模型
- [[transmission-line-model|输电线路模型]] - 相模变换和分布参数线路实时求解
