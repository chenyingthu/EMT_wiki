...
## 相关方法
- [[parameter-identification|参数辨识]] - 参数提取的通用框架
- [[vector-fitting|矢量拟合]] - 频域对比方法
- [[state-space-method|状态空间法]] - 状态空间实现
- [[model-order-reduction|模型降阶方法]] - 模态降阶

## 相关模型
- [[fdne-model|FDNE模型]] - 网络等值模态提取
- [[transmission-line-model|输电线路模型]] - 线路参数辨识
- [[transformer-model|变压器模型]] - 饱和特性辨识

## 相关主题
- [[frequency-dependent-modeling|频率相关建模]] - 宽频建模应用
- [[network-equivalent|网络等值]] - 等值模态分析
- [[harmonic-analysis|谐波分析]] - 谐波模态提取
