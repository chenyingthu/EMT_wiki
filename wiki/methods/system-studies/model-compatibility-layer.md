...
延迟型接口（如 [[interface-technique]] 中利用传输线延迟解耦）在接口处引人额外动力学特性。当延迟不匹配或插值精度不足时，可能导致高频数值振荡。Mudunkotuwa 2018 的 EMT-DP 协同仿真中指出，阻尼因子 $\alpha = 0.93 \sim 0.97$ 可有效抑制这类振荡。
...
- [[lessons-learned-in-porting-offline-large-scale-power-system-simulation-to-real-t]] — Hydro-Québec 离线大系统到实时 HYPERSIM 的移植经验，六步工作流，工具链和模型库映射实践
- [[co-simulation-of-electrical-networks-by-interfacing-emt-and-dynamic-phasor-simul]] — EMT-DP 协同仿真架构，传输线延迟解耦，5.26× 加速比
- [[functional-mock-up-interface-based-parallel-multistep-approach-with-signal-corre]] — FMI 并行多步协同仿真，三种步长关系模式，线性外推信号校正
- [[msemt-an-advanced-modelica-library-for-power-system-electromagnetic-transient-st]] — MSEMT Modelica 库，方程级 EMT 建模，模型与求解器解耦
- [[electromagnetic-transient-modeling-of-asynchronous-machine-in-modelica-accuracy-]] — 异步电机 Modelica EMT 建模，精度与性能验证
- [[development-of-data-translators-for-interfacing-13&14]] — 数据转换器作为工具接口和模型迁移的入口实现