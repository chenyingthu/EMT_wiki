...
$$
\mathbf {I} _ {k} = \mathbf {Y} _ {\mathbf {c}} \mathbf {V} _ {k} - \mathbf {H} (\mathbf {Y} _ {\mathbf {c}} \mathbf {V} _ {m} + \mathbf {I} _ {m}) \tag {1}
$$
...
$$
\mathbf {H} = e ^ {(- \sqrt {\mathbf {Y _ {s} Z _ {s}}} \ell)} \tag {2}
$$
...
$$
\mathbf {H} = e ^ {(\mathbf {T} \boldsymbol {\Lambda} \mathbf {T} ^ {- 1})} = \mathbf {T} e ^ {\boldsymbol {\Lambda}} \mathbf {T} ^ {- 1} \tag {6}
$$
...
![](images/4c623e13c41e82bf8b071318d3c23ea8b60a134ee02eea523b0a4932313eb5ea.jpg)  
...
![](images/c352313401f63f8bafc02f6ba45c6aa6481e74ed220e5b4357d802645383d13b.jpg)  
...
![](images/026481737f0593bfb22bcfdd4e02e40f3316cb49195746a982825f6f85a6ae51.jpg)  
...
![](images/c79dc188ce3eeb77657411dc37db03ab5d8365cf9e7aa3f26215bd02a3c07188.jpg)  
...
$$
\mathbf {x} _ {n + 1} \cong \frac {\mathbf {I} + \mathbf {A} \frac {\Delta t}{2}}{\mathbf {I} - \mathbf {A} \frac {\Delta t}{2}} \mathbf {x} _ {n} + \frac {\mathbf {I} \frac {\Delta t}{2}}{\mathbf {I} - \mathbf {A} \frac {\Delta t}{2}} \mathbf {B} (u _ {n + 1} + u _ {n}) \tag {24}
$$
...
![](images/e2203be3afb77b3a54074c4abb04bc65850a22877f54852c62ee64910a478297.jpg)  
...
![](images/94cdcbf4ee88a2f3217ba9617aea3276f31e96fb0880436c0dd13b89f8f8f833.jpg)  
Fig. 6. Voltage $\mathtt { V } _ { 1 0 }$ for CBEWB, FDQ, and WB, for $\Delta t = 1 \mu \mathrm { s } .$ .

![](images/1a45ffd60e3290d57b0effaf7526606a903ceb600e5382fa80aa363023c5ccbe.jpg)  
...
![](images/3cc48963a116bc499ad56604b00be30c82fe351382c6f045ba039b33f6595e8a.jpg)  
Fig. 8. Voltage $\mathtt { V } _ { 1 0 }$ for CWB, FDQ, and WB $\Delta t = 0 . 1 \ \mu \mathrm { s }$ .

![](images/0c006284054242dad5236c4170495470710490e5bc50de6a2cb6ca21461655ba.jpg)  
Fig. 9. Voltage $\mathtt { V } _ { 1 0 }$ for WB at $\Delta t = 0 . 0 1 \mu \mathrm { s }$ .

![](images/ffa0db7c9554107b77f959d035684a4df4492a54aaab9076bea1e630197c2eb5.jpg)  
...
![](images/aa229cb3b87557ac68677b14610c51eadbdf3b715e918740f274bff15346c21e.jpg)  
Fig. 11. Transient response comparison with FD (100 kHz) and CWB (overlapped).

![](images/6162b1745ed8f6afb765722c9d81fc1cbe40411d3f471ce2d9fd5627d6a9a5a8.jpg)  
Fig. 12. Transient response difference between FD (50 Hz) and CWB.

![](images/7aa4ccf4513827a23f19c3b3a94d4532ac4f242433bf5015052d6dc1c01c8369.jpg)  
...
![](images/72e53ebfac99eaf77c926d7fa502c5501ee1896dc5af99d6f67f67c0606fd06f.jpg)  
