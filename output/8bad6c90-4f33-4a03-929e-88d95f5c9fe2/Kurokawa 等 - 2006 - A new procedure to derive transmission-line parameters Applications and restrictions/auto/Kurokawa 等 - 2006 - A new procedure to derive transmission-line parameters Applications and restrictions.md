...
$$
\mathrm { \frac { d ^ { 2 } [ V _ { p h } ] } { d x ^ { 2 } } = [ Z ] [ Y ] [ V _ { p h } ] ; \quad \frac { d ^ { 2 } [ I _ { p h } ] } { d x ^ { 2 } } = [ Y ] [ Z ] [ I _ { p h } ] . }\tag{1}
$$
...
$$
[ \mathrm { T _ { I } } ] ^ { - 1 } [ \mathrm { Y } ] [ \mathrm { Z } ] [ \mathrm { T _ { I } } ] = [ \lambda ]\tag{2}
$$
...
$$
\mathrm { \frac { d ^ { 2 } [ E ] } { d x ^ { 2 } } = [ Z _ { m } ] [ Y _ { m } ] [ E ] ; \quad \mathrm { \frac { d ^ { 2 } [ I ] } { d x ^ { 2 } } = [ Y _ { m } ] [ Z _ { m } ] [ I ] } }\tag{3}
$$

where matrices $[ Z _ { \mathrm { m } } ]$ and $[ \mathrm { Y } _ { \mathrm { m } } ]$ are obtained as follows [7]:

$$
\mathrm { [ Z _ { m } ] = [ T _ { I } ] ^ { t } [ Z ] [ T _ { I } ] ; \quad [ Y _ { m } ] = [ T _ { I } ] ^ { - 1 } [ Y ] [ T _ { I } ] ^ { - t } }\tag{4}
$$

where $[ \mathrm { T } _ { \mathrm { I } } ] ^ { \mathrm { t } }$ is the transposed of $[ \mathrm { T } _ { \mathrm { I } } ]$ and $[ \mathrm { T } _ { \mathrm { I } } ] ^ { - \mathrm { t } }$ is the inverse of .
...
$$
\mathrm { E _ { A } } = \mathrm { E _ { B } } \cosh ( \gamma \mathrm { d } ) - \mathrm { I _ { B } } \mathrm { Z _ { c } } \sinh ( \gamma \mathrm { d } )\tag{5}
$$

$$
\mathrm { I _ { A } = - I _ { B } \cosh ( \gamma d ) + \frac { E _ { B } } { Z _ { c } } \sinh ( \gamma d ) } .\tag{6}
$$

In (5) and $( 6 ) , \mathrm { E _ { A } }$ and $\mathrm { E _ { B } }$ are, respectively, modal voltages at terminals A and B as described in Fig. 1. The terms $\mathrm { I _ { A } }$ and $\mathrm { I _ { B } }$ are modal currents at these terminations and is the line length. The terms $\gamma$ and $\mathrm { Z _ { c } }$ are, respectively, the propagation constant and the characteristic impedance of the mode and are written as being [2]

![](images/8f1b7ef49d000678fa81472012083ad998e05503dd6870b8ec3a17a5714929e8.jpg)  
Fig. 1. Generic mode of a transmission line.

$$
\gamma = \sqrt \mathrm { z y }\tag{7}
$$

$$
\mathrm { Z _ { c } = \sqrt { \frac { z } { y } } }\tag{8}
$$
...
$$
\mathrm { Z = \frac { Z _ { L } \cosh ( \gamma d ) + Z _ { c } \sinh ( \gamma d ) } { \cosh ( \gamma d ) + \left( \frac { Z _ { L } } { Z _ { c } } \right) \sinh ( \gamma d ) } . }\tag{9}
$$
...
$$
\mathrm { Z _ { o p e n } = \frac { E _ { A o p e n } } { I _ { A o p e n } } . }\tag{10}
$$
...
$$
\mathrm { Z _ { c c } = \frac { E _ { A c c } } { I _ { A c c } } . }\tag{11}
$$

By manipulating (9), it is possible to write $\mathrm { Z _ { c c } }$ and $\mathrm { Z _ { o p e n } }$ of each mode as functions of $\gamma$ re $\mathrm { Z _ { c } }$ as being

$$
\mathrm { Z _ { c c } = Z _ { c } \ t a n h ( \gamma d ) }\tag{12}
$$

$$
\mathrm { Z _ { o p e n } = Z _ { c } \coth ( \gamma d ) . }\tag{13}
$$

It is possible to observe that the equivalent impedances can be calculated directly from currents and voltages of the line, by using (10) and (11), or directly from $\gamma \mathrm { ~ e ~ } \mathrm { Z } _ { \mathrm { c } } .$ , by using (12) and (13).
...
$$
[ \mathrm { E } _ { \mathrm { m } } ] = [ \mathrm { T } _ { \mathrm { I } } ] ^ { \mathrm { t } } [ \mathrm { V } _ { \mathrm { p h } } ]\tag{14}
$$

$$
[ \mathrm { I _ { m } } ] _ { \mathrm { o p e n } } = [ \mathrm { T _ { I } } ] ^ { - 1 } [ \mathrm { I _ { p h } } ] _ { \mathrm { o p e n } }\tag{15}
$$

$$
[ \mathrm { I _ { m } } ] _ { \mathrm { c c } } = [ \mathrm { T _ { I } } ] ^ { - 1 } [ \mathrm { I _ { p h } } ] _ { \mathrm { c c } } .\tag{16}
$$
...
$$
\mathrm { c o t h ( \gamma d ) } = \sqrt { \frac { \mathrm { Z _ { o p e n } } } { \mathrm { Z _ { c c } } } } .\tag{17}
$$
...
$$
{ \frac { \mathrm { e } ^ { \gamma \mathrm { d } } + \mathrm { e } ^ { - \gamma \mathrm { d } } } { \mathrm { e } ^ { \gamma \mathrm { d } } - \mathrm { e } ^ { - \gamma \mathrm { d } } } } = { \sqrt { \frac { \mathrm { Z } _ { \mathrm { o p e n } } } { \mathrm { Z } _ { \mathrm { c c } } } } } .\tag{19}
$$

After algebraic manipulation of (19), it is possible to express of each mode as being

$$
\gamma = \mathrm { { \frac { 1 } { 2 d } } ( l n X + j \cos ^ { - 1 } F ) . }\tag{20}
$$

In (20), is the line length and X and F are written as being

$$
\mathrm { X } = { \frac { ( 1 + \mathrm { C _ { 1 } } ) ^ { 2 } + ( \mathrm { C _ { 2 } } ) ^ { 2 } } { \sqrt { { ( 1 - \mathrm { C _ { 1 } ^ { 2 } } - \mathrm { C _ { 2 } ^ { 2 } } ) } ^ { 2 } + 4 \mathrm { C _ { 2 } ^ { 2 } } } } }\tag{21}
$$

![](images/480ae16f186853a38c850972b885c3df2fbc02a477494575d68c13e5c02942bb.jpg)  
Fig. 2. Behavior of the imaginary part of  for a generic mode.

$$
\mathrm { F } = - \frac { 1 - \left( \mathrm { C _ { 1 } ^ { 2 } + C _ { 2 } ^ { 2 } } \right) } { \sqrt { \left( 1 - \mathrm { C _ { 1 } ^ { 2 } - C _ { 2 } ^ { 2 } } \right) ^ { 2 } + 4 \mathrm { C _ { 2 } ^ { 2 } } } }\tag{22}
$$

$$
\sqrt { \frac { \mathrm { Z _ { o p e n } } } { \mathrm { Z _ { c c } } } } = \mathrm { C _ { 1 } } + \mathrm { j \mathrm { C _ { 2 } } . }\tag{23}
$$
...
$$
\mathrm { C _ { 1 } } \neq \pm 1 \quad \mathrm { a n d } \quad \mathrm { C _ { 2 } } \neq 0 .\tag{24}
$$
...
$$
\mathrm { G } = \mathrm { I m } ( \sqrt { \mathrm { z y } } )\tag{25}
$$

$$
\mathrm { G ^ { \prime } = \frac { 1 } { 2 d } c o s ^ { - 1 } F . }\tag{26}
$$
...
$$
\mathrm { H ( f _ { k } ) } = \left. \frac { \partial \mathrm { G ^ { \prime } ( f _ { k } ) } } { \partial \mathrm { f } } \right. \left( \mathrm { f _ { k } - f _ { k - 1 } } \right) + \mathrm { H } ( \mathrm { f _ { k - 1 } } )\tag{27}
$$

where

$$
\frac { \partial \mathrm { G } ^ { \prime } ( \mathrm { f } _ { \mathrm { k } } ) } { \partial \mathrm { f } } \approx \frac { \mathrm { G } ^ { \prime } ( \mathrm { f } _ { \mathrm { k } } ) - \mathrm { G } ^ { \prime } ( \mathrm { f } _ { \mathrm { k } - 1 } ) } { \mathrm { f } _ { \mathrm { k } } - \mathrm { f } _ { \mathrm { k } - 1 } } .\tag{28}
$$

Equation (27) must be used if $\mathrm { f _ { k } }$ is larger than $\mathrm { f _ { 1 } }$ . If $\mathrm { f _ { k } }$ is lower than $\mathrm { f _ { 1 } }$ , then H(f) is written as being

$$
\begin{array} { r } { \mathrm { H } ( \mathrm { f } _ { \mathrm { k } } ) = \mathrm { G } ^ { \prime } ( \mathrm { f } _ { \mathrm { k } } ) . } \end{array}\tag{29}
$$
...
$$
{ \frac { \mathrm { z } } { \mathrm { y } } } = \mathrm { Z _ { c c } } \mathrm { Z _ { o p e n } } .\tag{30}
$$

Solving (7) and (30)

$$
\mathrm { z } = \gamma \sqrt { \mathrm { Z _ { c c } \mathrm { Z _ { o p e n } } } }\tag{31}
$$

$$
\mathrm { y } = \frac { \gamma } { \sqrt { \mathrm { Z _ { \mathrm { c c } } Z _ { \mathrm { o p e n } } } } } .\tag{32}
$$
...
$$
[ \mathrm { Z } ] = [ \mathrm { T _ { I } } ] ^ { - \mathrm { t } } [ \mathrm { Z } _ { \mathrm { m } } ] [ \mathrm { T } _ { \mathrm { I } } ] ^ { - 1 }\tag{33}
$$
...
$$
\mathrm { [ T _ { I } ] = \left[ \begin{array} { l l } { 1 } & { 1 } \\ { 1 } & { - 1 } \end{array} \right] . }\tag{35}
$$
...
First, phase currents and voltages in the frequency domain in one terminal of the line, considering that the other terminal is open and short-circuited, were obtained considering the line represented through (5) and (6). Then, using the methodology developed in this paper, the longitudinal and transversal parameters were calculated. Finally, these parameters were compared with parameters obtained by using the procedure shown in Section II.

![](images/d8e79b16f332d1bc1899fd1858e647f2c35fd469ec48b25ea47f7a585b9c8326.jpg)  
Fig. 3. Two-phase transmission line.

![](images/cc460ba633891c39d13e324adc2d44f89bf953733d7c1808192915fb45702bb8.jpg)  
...
![](images/494588e3dcdfd8ddc9cd1f37388e2460a2c9df28d647753d9137f1452aa57749.jpg)  
...
![](images/569bebf312acb8a9c94ab0acf2fcb260443f28735eea26017acd65523ac64f0b.jpg)  
...
![](images/231a6a28e476fabf8f37682a9ff3d7c34d16625578692acf0eb4285aa8588134.jpg)  
Fig. 7. A 440-kV three-phase transmission line.

![](images/48e4a2da168e054d254a19f35adb3b704b290b7a41800b216ae47e9c292fcd0e.jpg)  
...
![](images/f8a28a225d131bbfeacd273de6ccc3899827071faccd8f464dcd1ba3729c1f8c.jpg)  
...
![](images/cb04f7db728fcfd7493be5e9adb972b1a42443a357dbdf599913c6bee0700f2f.jpg)  
