...
TABLE I  
MODELING AND SIMULATION METHODS TO STUDY THE INTERACTIONS BETWEEN AC/DC GRIDS
<table><tr><td>Simulation method</td><td>Issues can be resolved</td><td>Issues cannot be resolved</td></tr><tr><td> Norton/Thevenin equivalent [9]</td><td>Design of the DC grids</td><td>No wide frequency band and harmonic interactions can be captured</td></tr><tr><td>TS-EMT simulations [10][11]</td><td>Low-frequency</td><td>No wide frequency band and harmonic interactions can be captured</td></tr><tr><td></td><td>dynamic interactions between AC and DC grids</td><td></td></tr><tr><td>TS-DP-EMT simulations[12][13]</td><td>Low order harmonic interactions between AC/DC grids</td><td>Cannot produce wide frequency band /harmonic phasors and instantenous values simultaneously</td></tr></table>

![](images/fbdfa449c10a993e5e10c8c131f3129e2681cd2c0743847a1074438cb55b5f49.jpg)  
Fig. 1. Modeling to study the interactions between AC/DC grids

Let us pause for a moment and make the reader think about the essential purpose of time-domain simulations despite improving the simulation efficiency while satisfying the accuracy expectations: (1) Is the purpose of EMT simulation only to reproduce the results of time domain simulations? (2) Whether time domain simulation can provide additional information for harmonic interactions? (3) After thoroughly investigating previous work, we cannot help to think that is there any new method modeling of power electronic devices, which can produce large-signal dynamics for harmonic analysis after the occurrence/clearance of the fault?
...
(iii) the proposed HPD model can produce instantaneous time-domain waveforms and instantaneous harmonic phasor waveforms simultaneously. Noticeably, the harmonic phasor waveforms can be the exact envelopes of the instantaneous harmonic values;

![](images/82e27aef2de33646691956e2b0decbcea2b9264a4a9ee865abc6d0ae9346d8db.jpg)  
...
$$
\begin{array} { r l } & { \langle x \rangle _ { k } ( t ) = \left[ \begin{array} { l l } { \langle x \rangle _ { k } ^ { R } \left( t \right) } & { \langle x \rangle _ { k } ^ { I } \left( t \right) } \end{array} \right] } \\ & { \langle x \rangle _ { k } ^ { R } \left( t \right) = \mathrm { R e } \left\{ \frac { 1 } { T } \int \displaylimits _ { t - T } ^ { t } x ( \tau ) e ^ { - j k \omega _ { s } \tau } d \tau \right\} , } \\ & { \langle x \rangle _ { k } ^ { I } \left( t \right) = \mathrm { I m } \left\{ \frac { 1 } { T } \int \displaylimits _ { t - T } ^ { t } x ( \tau ) e ^ { - j k \omega _ { s } \tau } d \tau \right\} } \end{array}\tag{1}
$$
...
$$
\begin{array} { r l } & { \langle \boldsymbol { x } \rangle _ { k } ^ { H D } \left( t \right) = \left[ \begin{array} { c c } { \langle \boldsymbol { x } \rangle _ { k } ^ { R } \left( t \right) } & { \langle \boldsymbol { x } \rangle _ { k } ^ { I } \left( t \right) } \end{array} \right] \mathbf { T } ( - k , t ) , } \\ & { \mathbf { T } ( k , t ) = \left[ \begin{array} { c c } { \cos k \omega _ { s } t } & { - \sin k \omega _ { s } t } \\ { \sin k \omega _ { s } t } & { \cos k \omega _ { s } t } \end{array} \right] , } \end{array}\tag{2}
$$
...
$$
\frac { d \langle x \rangle _ { k } ( t ) } { d t } = A \langle x \rangle _ { k } ( t ) + B \langle u \rangle _ { k } ( t ) , k = 0 , 1 , 2 . . . .\tag{3}
$$
...
$$
\frac { d \left. x \right. _ { k } ^ { H D } \left( t \right) } { d t } = A \left. x \right. _ { k } ^ { H D } \left( t \right) + B \left. u \right. _ { k } ^ { H D } \left( t \right) - \left. x \right. _ { k } ^ { H D } \left( t \right) \mathbf { T } ( k , - \frac { \pi } { 2 k \omega _ { s } } )\tag{4}
$$

After discretization of (4), the update of kth harmonics in a instantaneous way can be calculated as:

$$
\begin{array} { r l } & { \frac { \langle x \rangle _ { k } ( t ) - \langle x \rangle _ { k } ( t - \Delta t ) \mathbf { T } ( k , - \Delta t ) } { \Delta t } } \\ & { = \frac { 1 } { 2 } \left[ \begin{array} { l } { \mathbf { A } \left. x \right. _ { k } \left( t \right) + \boldsymbol { B } \left. u \right. _ { k } \left( t \right) - \left. x \right. _ { k } \left( t \right) \mathbf { T } ( k , - \frac { \pi } { 2 k \omega _ { s } } ) } \\ { + \mathbf { A } \left. x \right. _ { k } \left( t - \Delta t \right) \mathbf { T } ( k , - \Delta t ) + } \\ { \boldsymbol { B } \left. u \right. _ { k } \left( t - \Delta t \right) \mathbf { T } ( k , - \Delta t ) - \left. x \right. _ { k } \left( t - \Delta t \right) \mathbf { T } ( k , - \Delta t - \frac { \pi } { 2 k \omega _ { s } } ) } \end{array} \right] } \end{array}
$$

$$
\begin{array} { r l } & { \left[ \begin{array} { c c } { \operatorname { R e } \left( G _ { c , k } + G _ { r 1 , k } \right) } & { - \operatorname { I m } \left( G _ { c , k } + G _ { l 1 , k } \right) } \\ { \operatorname { I m } \left( G _ { c , k } + G _ { r 1 , k } \right) } & { \operatorname { R e } \left( G _ { c , k } + G _ { l 1 , k } \right) } \\ { \quad - \operatorname { R e } \left( G _ { l 1 , k } \right) } & { \operatorname { I m } \left( G _ { l 1 , k } \right) } \\ { \quad - \operatorname { I m } \left( G _ { l 1 , k } \right) } & { - \operatorname { R e } \left( G _ { l 1 , k } \right) } \end{array} \right. - \operatorname { R e } \left( G _ { r 1 , k } \right) } & { \operatorname { I m } \left( G _ { r 1 , k } \right) } \\ & { = \left[ \begin{array} { c c } { I _ { k } \sin k \omega t } \\ { I _ { k } \cos k \omega t } \\ { 0 } \end{array} \right] + \left[ \begin{array} { c c } { J _ { c , x } ( t - \Delta t ) + J _ { l 1 , x } ( t - \Delta t ) } \\ { J _ { c , y } ( t - \Delta t ) + J _ { l 1 , y } ( t - \Delta t ) } \\ { - J _ { l 1 , x } ( t - \Delta t ) + J _ { l 2 , x } ( t - \Delta t ) } \\ { - J _ { l 1 , y } ( t - \Delta t ) + J _ { l 2 , y } ( t - \Delta t ) } \end{array} \right] } \end{array} \right] \left[ \begin{array} { c } { \nu _ { k , x } ^ { 1 } ( t ) } \\ { \nu _ { k , y } ^ { 1 } ( t ) } \\ { \nu _ { k , x } ^ { 2 } ( t ) } \\ { \nu _ { k , x } ^ { 2 } ( t ) } \\ { \nu _ { k , y } ^ { 2 } ( t ) } \end{array} \right]  \\ &  = \left[ \begin{array} { c } { I _ { k } \sin k \omega t } \\ { I _ { k } \cos k \omega t } \\ { 0 } \end{array} \right] + \left[ \begin{array} { c } { J _ { c , x } ( t - \Delta t ) + J _ { l 1 , x } ( t - \Delta t ) } \\  J \end{array}\tag{11}
$$
...
![](images/456d2e9359843268fae20a12c37403ec514217e8524982e613bb612d4e255f05.jpg)  
...
$$
C \frac { d \langle u _ { c } \rangle _ { k } ( t ) } { d t } = \langle i _ { c } \rangle _ { k } ( t )\tag{6}
$$
...
$$
C \frac { d \left. u _ { c } \right. _ { k } ^ { H D } \left( t \right) } { d t } = \left. i _ { c } \right. _ { k } ^ { H D } \left( t \right) - \left. u _ { c } \right. _ { k } ^ { H D } \left( t \right) \mathbf { T } ( k , - \frac { \pi } { 2 k \omega _ { s } } )\tag{7}
$$
...
$$
\langle i _ { c } \rangle _ { k } \left( t \right) = G _ { c , k } \left. u _ { c } \right. _ { k } \left( t \right) + J _ { c , k } \left( t - \Delta t \right)\tag{8}
$$

where

$$
\left\{ \begin{array} { c } { G _ { c , k } = \frac { 2 C } { \Delta t } { + } \mathbf { T } ( k , - \frac { \pi } { 2 k \omega _ { s } } ) } \\ { J _ { c , k } ( t - \Delta t ) = \langle u _ { c } \rangle _ { k } \left( t - \Delta t \right) \mathbf { T } ( k , \Delta t - \frac { \pi } { 2 k \omega _ { s } } ) } \\ { - \langle i _ { c } \rangle _ { k } \left( t - \Delta t \right) \mathbf { T } ( k , \Delta t ) } \end{array} \right.\tag{9}
$$
...
$$
\begin{array} { r l } & { \left[ \begin{array} { l l } { \operatorname { R e } \left( G _ { k } \right) } & { - \operatorname { I m } \left( G _ { k } \right) } \\ { \operatorname { I m } \left( G _ { k } \right) } & { \operatorname { R e } \left( G _ { k } \right) } \end{array} \right] \left[ \begin{array} { l } { \nu _ { k , x } ( t ) } \\ { \nu _ { k , y } ( t ) } \end{array} \right] } \\ & { = \left[ \begin{array} { l } { i _ { k , x } ( t ) } \\ { i _ { k , y } ( t ) } \end{array} \right] + \left[ \begin{array} { l } { J _ { k , x } ( t - \Delta t ) } \\ { J _ { k , y } ( t - \Delta t ) } \end{array} \right] } \end{array}\tag{10}
$$
...
$$
\begin{array} { l } { s X = ( A - N ) X + B U , } \\ { X = \left[ \begin{array} { l l l } { \ldots } & { \widehat { x } ( s _ { 1 } ) } & { \widehat { x } ( s ) } & { \widehat { x } ( s _ { - 1 } ) , \ldots } \end{array} \right] ^ { T } } \end{array}\tag{12}
$$

All the final results, such as $. . . . . , \hat { x } ( s _ { 2 } ) , \hat { x } ( s _ { 1 } ) , \hat { x } ( s ) , \hat { x } ( s _ { - 1 } ) , \hat { x } ( s _ { - 2 } ) , . . . .$ . are only steady state phasor values, or $\hat { x } ( s _ { i } ) = \left| \hat { x } ( s _ { i } ) \right| \angle \hat { x } ( s _ { i } )$ , where $\vert \hat { x } ( s _ { i } ) , \ \vert \angle \hat { x } ( s _ { i } )$ denote the phasor value and the angle value of the harmonics in the frequency domain.
...
The reason is given below: Suppose the original frequency band of simulated system is $\left[ \left( k - 1 \right) \omega _ { s } - \Delta \omega , k \omega _ { s } + \Delta \omega \right] , k :$ $k =$ $1 , 2 . . . . N , N = [ \omega _ { \mathrm { m a x } } / \omega _ { s } ] + 1 , \Delta \omega \ll \omega _ { s }$ where $\omega _ { s }$ denote the fundamental frequency; $\omega _ { m a x }$ is the maximum frequency. Based on our proposed HPD models, the $\mathrm { k } ^ { t h }$ frequency band will be shifted to $[ - \Delta \omega , \Delta \omega ]$ . According to the Nyquist criterion, the maximum time-step for HPD models should satisfy $\Delta T _ { \mathrm { m a x } } \leq \pi / \Delta \omega$ , where the traditional EMT models should satisfy $\Delta T _ { \mathrm { m a x } } \leq \pi / \left( N \omega _ { s } + \Delta \omega \right)$ . This is the reason why the proposed method can extend time-step to a significantly larger one.
...
$$
\langle i _ { d c } \rangle _ { k } ^ { H D } = \frac { 1 } { 2 } \sum _ { l = - \infty } ^ { \infty } \left( \begin{array} { l } { { \langle i _ { a } \rangle _ { l } ^ { H D } \langle S _ { a } \rangle _ { k - l } ^ { H D } + } } \\ { { \langle i _ { b } \rangle _ { l } ^ { H D } \langle S _ { b } \rangle _ { k - l } ^ { H D } + \langle i _ { c } \rangle _ { l } ^ { H D } \langle S _ { c } \rangle _ { k - l } ^ { H D } } } \end{array} \right)\tag{14}
$$
...
$$
\begin{array} { r } { L \frac { d \langle i _ { a } \rangle _ { k } ^ { H D } } { d t } = \langle u _ { \boldsymbol { a } } ^ { \prime } \rangle _ { k } ^ { H D } - \langle u _ { \boldsymbol { a } } \rangle _ { k } ^ { H D } - \Big ( R + \mathbf { T } ( k , - \frac { \pi } { 2 k \omega _ { s } } ) L \Big ) \langle i _ { a } \rangle _ { k } ^ { H D } } \end{array}
$$

$$
\begin{array} { r } { L \frac { d \langle i _ { b } \rangle _ { k } ^ { H D } } { d t } = \langle u ^ { \prime } { } _ { b } \rangle _ { k } ^ { H D } - \langle u _ { b } \rangle _ { k } ^ { H D } - \Big ( R + { \bf T } ( k , - \frac { \pi } { 2 k \omega _ { s } } ) L \Big ) \langle i _ { b } \rangle _ { k } ^ { H D } } \end{array}
$$

$$
\begin{array} { r } { L \frac { d \langle i _ { c } \rangle _ { k } ^ { H D } } { d t } = \langle u _ { \mathit { c } } ^ { \prime } \rangle _ { k } ^ { H D } - \langle u _ { c } \rangle _ { k } ^ { H D } - \Big ( R + { \mathbf T } ( k , - \frac { \pi } { 2 k \omega _ { s } } ) L \Big ) \langle i _ { c } \rangle _ { k } ^ { H D } } \end{array}\tag{15}
$$

$$
\left\{ \begin{array} { l l }  { { \langle { { u _ { a } } } \rangle } _ { k } ^ { H D } = \frac { 1 } { 2 } { { \langle { { u _ { d c } } } { { S _ { c } } } \rangle } _ { k } ^ { H D } } - { { \langle { { u _ { 0 } } } \rangle } _ { k } ^ { H D } } = \frac { 1 } { 2 } \sum _ { l = - \infty } ^ { \infty } \left( { { { \langle { { u _ { d c } } } \rangle } _ { l } ^ { H D } } \cdot { { \langle { { S _ { a } } } \rangle } _ { k - l } ^ { H D } }  - { \langle { { u _ { 0 } } } \rangle } _ { k } ^ { H D } } } \\  {\right) { \langle { { u _ { b } } } \rangle } _ { k } ^ { H D } = \frac { 1 } { 2 } { { \langle { { u _ { d c } } } { S _ { b } } \rangle } _ { k } ^ { H D } } - { { \langle { { u _ { 0 } } } \rangle } _ { k } ^ { H D } } = \frac { 1 } { 2 } \sum _ { l = - \infty } ^ { \infty } \left( { { { \langle { { u _ { d c } } } \rangle } _ { l } ^ { H D } } \cdot { { \langle { { S _ { b } } } \rangle } _ { k - l } ^ { H D } }  - { \langle { { u _ { 0 } } } \rangle } _ { k } ^ { H D } } } \\   \right){ \langle { { u _ { c } } } \rangle } _ { k } ^ { H D } = \frac { 1 } { 2 } { { \langle { { u _ { d c } } } { S _ { c } } \rangle } _ { k } ^ { H D } } - { \langle { { u _ { 0 } } } \rangle } _ { k } ^ { H D } = \frac { 1 } { 2 } \sum _ { l = - \infty } ^ { \infty } \left( { { { \langle { { u _ { d c } } } \rangle } _ { l } ^ { H D } } \cdot { { \langle { { S _ { c } } } \rangle } _ { k - l } ^ { H D } } \right) - { \langle { { u _ { 0 } } } \rangle } _ { k } ^ { H D } } \end{array} \right.\tag{13}
$$

![](images/ddbb61b68d061c8ad0f063ec8767ec03088c65cde56e13d326c7e4f6b67d0b5a.jpg)

Fig. 4. HPD model of two-level VSC  
![](images/18cbd110dd48d46bc3bbd477853efca2163f59a01baf1e493bf44e7ff66cf0f6.jpg)  
...
$$
C \frac { d \left. u _ { d c } \right. _ { k } ^ { H D } } { d t } = \left. i _ { d c } ^ { \prime } \right. _ { k } ^ { H D } - \left. i _ { d c } \right. _ { k } ^ { H D } - { \bf T } ( k , - \frac { \pi } { 2 k \omega _ { s } } ) C \left. u _ { d c } \right. _ { k } ^ { H D }\tag{16}
$$
...
![](images/0921b433cd5d5a2cc022578146691ece58532e040f7df33b56ddfc3a66d98106.jpg)  
...
$$
\begin{array} { r l } & { \left[ \Delta t \mathbf { T } ( k , - \frac { \pi } { 2 k \omega _ { s } } ) - I \right] \langle u \rangle _ { k } ( t ) } \\ & { = \left[ K _ { p } - \frac { \Delta t } { T _ { i } } - \Delta t \mathbf { T } ( k , - \frac { \pi } { 2 k \omega _ { s } } ) \right] \langle x \rangle _ { k } ( t ) } \\ & { - K _ { p } \mathbf { T } ( k , \Delta t ) \langle x \rangle _ { k } \left( t - \Delta t \right) - \langle u \rangle _ { k } \left( t - \Delta t \right) \mathbf { T } ( k , \Delta t ) } \end{array}\tag{19}
$$
...
1) HPD Modeling of MMC Sub-modules: The HPD model of MMC sub-modules can be represented as a switched capacitor. According to (1)-(5), the capacitor of each submodule can be represented as:

$$
\left\{ \begin{array} { c } { { \left. G _ { c } \right. _ { k } ^ { H D } = \left[ I + \frac { \Delta t } { 2 } \mathbf { T } \left( k , - \frac { \pi } { 2 k \omega _ { s } } \right) \right] ^ { - 1 } \frac { \Delta t C } { 2 } } } \\ { { \left. J _ { c } \right. _ { k } ^ { H D } \left( t - \Delta t \right) = K _ { \nu } \left. i _ { c } \right. _ { k } ^ { H D } \left( t - \Delta t \right) + K _ { \nu } \left. u _ { c } \right. _ { k } ^ { H D } \left( t - \Delta t \right) } } \end{array} \right.\tag{20}
$$

where

$$
\left\{ \begin{array} { c } { { K _ { \nu } = \left[ I + \frac { \Delta t } { 2 } \mathbf { T } ( k , - \frac { \pi } { 2 k \omega _ { s } } ) \right] ^ { - 1 } \frac { \Delta t C } { 2 } } } \\ { { K _ { i } = \left[ I + \frac { \Delta t } { 2 } \mathbf { T } ( k , - \frac { \pi } { 2 k \omega _ { s } } ) \right] ^ { - 1 } \left[ I + \frac { \Delta t } { 2 } \mathbf { T } ( k , - \frac { \pi } { 2 k \omega _ { s } } ) \right] } } \end{array} \right.\tag{21}
$$
...
$$
\left\{ \begin{array} { c } { { \langle V _ { a r m } \rangle _ { k } ^ { H D } \left( t \right) = \sum _ { i \in \Omega } \left. G _ { c , i } \right. _ { k } ^ { H D } \left. J _ { c , i } \right. _ { k } ^ { H D } \left( t - \Delta t \right) } } \\ { { \langle R _ { a r m _ { - } e q } \rangle _ { k } ^ { H D } \left( t \right) = \sum _ { i \in \Omega } \left[ \left. G _ { c , i } \right. _ { k } ^ { H D } \right] ^ { - 1 } } } \end{array} \right.\tag{22}
$$

where Ω denotes the set, where all the submodules inside the arm are conducted; $\langle V _ { a r m } \rangle _ { k } ^ { H D } ( t ) , \ : \left. R _ { a r m \_ e q } \right. _ { k } ^ { H D } ( t )$ denote the $\mathrm { k } ^ { t h }$ harmonic phasor for the Thevenin voltage and impedance respectively.
...
$$
\left\{ \begin{array} { l l } { \frac { d \mathbf { u } _ { m } ( x , s ) } { d x } + s L \mathbf { i } _ { m } ( x , s ) = 0 } \\ { \frac { d \mathbf { i } _ { m } ( x , s ) } { d x } + s C \mathbf { u } _ { m } ( x , s ) = 0 } \end{array} \right.\tag{23}
$$
...
$$
\left\{ \begin{array} { c } { \frac { \partial ^ { 2 } \mathbf { u } _ { m } ( x , s ) } { \partial x ^ { 2 } } + L C s ^ { 2 } \mathbf { u } _ { m } ( x , s ) = 0 } \\ { \frac { \partial ^ { 2 } \mathbf { i } _ { m } ( x , s ) } { \partial x ^ { 2 } } + L C s ^ { 2 } \mathbf { i } _ { m } ( x , s ) = 0 } \end{array} \right.\tag{24}
$$

Performing inverse Laplace transformation to (24) yields :

$$
\left\{ \begin{array} { c } { \mathbf { u } _ { m } ( x , t ) = \mathbf { u } _ { m } ( t - \frac { x } { \nu } ) + \mathbf { u } _ { m } ( t + \frac { x } { \nu } ) } \\ { i _ { m } ( x , t ) = i _ { m } ( t - \frac { x } { \nu } ) + i _ { m } ( t + \frac { x } { \nu } ) } \end{array} \right.\tag{25}
$$
...
$$
\left\{ \begin{array} { l l } { \frac { \partial \langle { { u } _ { n } } \rangle _ { k } ^ { H D } ( x , t ) } { \partial x } + L \frac { \partial \langle { { i } _ { n } } \rangle _ { k } ^ { H D } ( x , t ) } { \partial t } + L \langle { { i } _ { n } } \rangle _ { k } ^ { H D } ( x , t ) { \mathbf { T } } ( k , - \frac { \pi } { 2 k { { \omega } _ { s } } } ) = 0 } \\ { \frac { \partial \langle { { i } _ { n } } \rangle _ { k } ^ { H D } ( x , t ) } { \partial x } + C \frac { \partial \langle { { u } _ { n } } \rangle _ { k } ^ { H D } ( x , t ) } { \partial t } + C \langle { { u } _ { n } } \rangle _ { k } ^ { H D } ( x , t ) { \mathbf { T } } ( k , - \frac { \pi } { 2 k { { \omega } _ { s } } } ) = 0 } \end{array} \right.\tag{27)(27}
$$
...
$$
\left\{ \begin{array} { c } { { \langle i _ { n } \rangle _ { k } ^ { H D } \left( t \right) = \langle u _ { n } \rangle _ { k } ^ { H D } \left( t \right) / Z + \langle I _ { n } \rangle _ { k } ^ { H D } \left( t - \tau \right) } } \\ { { \langle I _ { n } \rangle _ { k } ^ { H D } \left( t - \tau \right) = - Z ^ { - 1 } \left[ \langle u _ { m } \rangle _ { k } ^ { H D } \left( t - \tau \right) \mathbf { T } \left( k , - \theta \right) \right] } } \\ { { - \langle i _ { m } \rangle _ { k } ^ { H D } \left( t - \tau \right) \mathbf { T } \left( k , - \theta \right) } } \end{array} \right.\tag{28}
$$

where $\langle \rangle _ { k } ^ { H D } \left( t \right)$ denotes the $\mathrm { k } ^ { t h }$ harmonic phasor of the corresponding variable.
...
$$
\begin{array} { r l } & { \mathbf { u } _ { n } ( t - \tau ) = \operatorname { R e } \left\{ \underset { k = 1 } { \overset { N } { \sum } } \langle u _ { n } \rangle _ { k } ^ { H D } \left( t - \tau \right) \mathbf { T } ( k , t ) \right\} , } \\ & { i _ { n } ( t - \tau ) = \operatorname { R e } \left\{ \underset { k = 1 } { \overset { N } { \sum } } \langle i _ { n } \rangle _ { k } ^ { H D } \left( t - \tau \right) \mathbf { T } ( k , t ) \right\} } \end{array}\tag{29}
$$

$\left. u _ { n } \right. _ { k } ^ { H D } \left( t - \tau \right)$ is obtained by the interpolation in harmonic phasor domain:

$$
\begin{array} { r l } & { { \langle { u _ { n } } \rangle } _ { k } ^ { H D } \left( t - \tau \right) = \frac { i \Delta t - \tau } { \Delta t } { \langle { u _ { n } } \rangle } _ { k } ^ { H D } \left[ t - ( i - 1 ) \Delta t \right] { \bf T } \left[ k , \tau - ( i - 1 ) \Delta t \right] } \\ & { + \frac { \tau - ( i - 1 ) \Delta t } { \Delta t } { \langle { u _ { n } } \rangle } _ { k } ^ { H D } \left[ t - i \Delta t \right] { \bf T } \left[ k , \tau - i \Delta t \right] } \end{array}\tag{30}
$$
...
2) Update of HPD-TLM in the HPD subsystem: In order to calculate the Norton equivalent current $\left. I _ { n } \right. _ { k } ^ { \check { H } D } \left( t - \tau \right)$ in the form of the $\mathrm { k } ^ { t h }$ Fourier coefficient, the interface voltages and currents in the dynamic phasor form should be transformed to its harmonic phasor form by Fourier transform and rotational transform:

$$
\langle u _ { m } \rangle _ { k } ^ { H D } \left( t - \tau \right) = \langle u _ { m } \rangle _ { k } \left( t - \tau \right) \mathbf { T } ( k , - t )\tag{31}
$$

Where $\left. u _ { m } \right. _ { k } \left( t - \tau \right)$ denote the $\mathrm { k } ^ { t h }$ dynamic phasor.

![](images/83162877b886843b1c188600c0c7975811e5322ed9118f5d30eb2538c95e5e2e.jpg)  
Fig. 7. Harmonic phasor domain transmission line model (HPD-TLM)

![](images/d4e2166f0f2d658559042bc1e1e4593bf03ae27577f269012a89e23bc3196d57.jpg)  
...
$$
\begin{array} { r l } & { \langle u _ { m } \rangle _ { k } \left( t - \tau \right) = \frac { i \Delta t - \tau } { \Delta t } \langle u _ { m } \rangle _ { k } \left[ t - ( i - 1 ) \Delta t \right] } \\ & { + \frac { \tau - ( i - 1 ) \Delta t } { \Delta t } \langle u _ { m } \rangle _ { k } \left[ t - i \Delta t \right] } \end{array}\tag{32}
$$
...
TABLE II  
SCALE OF AC GRIDS IN EMT SUBSYSTEM
...
The phase diagram of the first order harmonic phasors of ac voltage, arm voltage and capacitor voltage will give us more interesting physical interpretations of dynamics (see Fig. 11). In Fig. 11, the green circle denotes the original state before the fault, and the blue circle denotes the final state after the fault. The dynamics of the AC voltages can be grouped into the homo-clinic orbit. That is to say, the AC voltages will return to the original steady state after the fault. The dynamics of the arm voltages and the capacitor voltages can be grouped into the hetero-clinic orbit [34]. That is to say, the arm voltages or the capacitor voltages will be gradually stabilized to a new steady state after the fault scenario.

![](images/f52943441d7c3cf8d2a9fbc944ce73c2c0aabdfad33951762d7257895b9d305c.jpg)

Fig. 14. Instantaneous and HDP curves of the AC voltages:(a) instantaneous values $u _ { a c } ; ( \mathbf { b } )$ fundamental $\langle u _ { a c } \rangle _ { 1 } ^ { H D } \rangle _ { }$ (c) second harmonic $\langle u _ { a c } \rangle _ { 2 } ^ { H D } ;$ (d) third harmonic $\langle u _ { a c } \rangle _ { 3 } ^ { H D }$  
![](images/b7fe53565ff780a8bf2332a68673745253ca68a205c294035be297625fa5908a.jpg)  
Fig. 15. Instantaneous and HDP curves of the AC currents:(a) instantaneous values $i _ { a c } ; ( \mathfrak { b } )$ fundamental $\langle i _ { a c } \rangle _ { 1 } ^ { H D } ;$ (c) second harmonic $\langle i _ { a c } \rangle _ { 2 } ^ { H D } ;$ ; (d) third harmonic $\langle i _ { a c } \rangle _ { 3 } ^ { H D }$
...
![](images/177536c49b117448919e5a0d40fca541ae4cdce9ed698bb08939977db8d2f71c.jpg)

Fig. 16. Instantaneous curves under different time-steps (a) ac voltage of phase A: $u _ { a c } ;$ (b) arm voltage of phase A: $u _ { a p }$ (c) capacitor voltage of phase A:  
![](images/170473f1b530400def624652b86ffd5b4d47e1957c7f1c633712b49afff82afe.jpg)  
...
(3) Each harmonic phasor uses multi-core CPUs, such as openMP techniques, for parallel simulation, so the order of harmonic phasor will not affect the simulation efficiency of harmonic subsystem.
...
<table><tr><td colspan="4">Execution Time(s)</td></tr><tr><td>PSCAD(MMC detailed switch model)</td><td></td><td>Proposed under different time-steps/μs</td><td>500</td></tr><tr><td>1.2×104</td><td>10 5000</td><td>100 480</td><td>120</td></tr><tr><td>PSCAD(MMC detailed</td><td></td><td></td><td>PSCAD(MMC equivalent model) /μs</td></tr><tr><td>switch model)</td><td>10</td><td>100</td><td>500</td></tr><tr><td>1.2×104</td><td>8000</td><td>980</td><td>/</td></tr></table>

## VI. APPENDIX

TABLE IV  
SYSTEM PARAMETERS OF THE MMCS
<table><tr><td>RMS AC voltage of converter T1 and T2</td><td>220kV</td></tr><tr><td>capacitor of each sub-module Vdc rated value</td><td>1200 μF</td></tr><tr><td>DC line: length D= 200 km</td><td>400kV</td></tr><tr><td>DC line: impedance r0</td><td>200km</td></tr><tr><td>DC line: inductance l0</td><td>0.012 Ω/km</td></tr><tr><td>DC line: capacitance cO</td><td>0.106 mH/km</td></tr><tr><td>Control Parameters:outer loop controllers of constant DC</td><td>0.296 μF/km</td></tr><tr><td>voltage: Kp= 2,KI=0.0025</td><td></td></tr><tr><td>outer loop controllers of constant reactive power: Kp = O.0o1,KI= 0.15;</td><td></td></tr><tr><td>the phase shift loop:Kp= 0.5,KI= 150.</td><td></td></tr></table>

TABLE V

SYSTEM PARAMETERS OF THE TWO-LEVEL VSCS
<table><tr><td>RMS AC voltage of converter T1 and T2</td><td>220kV</td></tr><tr><td>capacitor of each sub-module</td><td>1200 μF</td></tr><tr><td>Vdc rated value</td><td>200kV</td></tr><tr><td>Proportional parameter of dc voltage controller Kp_dc</td><td>0.2</td></tr><tr><td>Integral parameter of dc voltage controller Ki_dc</td><td>0.1</td></tr><tr><td>Proportional parameter of current controller Kpi Integral parameter of current controller Kii</td><td>8 0.25</td></tr></table>
...
![](images/407ec6eb1e942424c81d23b0929b9846b4a9d1db14b0c672abdb391213b2f73b.jpg)
...
![](images/2a4b406d030fef6f4958c20b3721e721526e46a3d2b7c3926b44b770a32f4db2.jpg)
...
![](images/b85cd53cce0c2a170d02bdc16629f3fd6d6c765dd4642f6dc19579afdf5395ec.jpg)  
systems.
