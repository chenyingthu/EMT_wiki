...
![](images/c8fa0d95cc18626e87ed763ecb8eb23f06268100eaff0aed3df281fe55120d63.jpg)  
图1 三相Y接CHB-PET拓扑结构

![](images/d17ebb5675eb5c370e4366da5074ced008b23f88e4c25160900ee8ca40a014be.jpg)  
Fig. 1 Three-phase Y-connected CHB-PET topology   
图2 变压器的解耦伴随电路  
Fig. 2 Decoupling companion circuit of transformer

$$
\begin{array}{l} \boldsymbol {I} (t) = \boldsymbol {\lambda} \cdot \boldsymbol {U} (t) + (\boldsymbol {Y} _ {\mathrm {M A T}} - \boldsymbol {\lambda}) \cdot \boldsymbol {U} (t) + \boldsymbol {I} _ {\mathrm {T E O}} (t - \Delta T) \approx \\ \boldsymbol {\lambda} \cdot \boldsymbol {U} (t) + \left(\boldsymbol {Y} _ {\mathrm {M A T}} - \boldsymbol {\lambda}\right) \cdot \boldsymbol {U} (t - \Delta T) + \\ \boldsymbol {I} _ {\mathrm {T E Q}} (t - \Delta T) \triangleq \boldsymbol {\lambda} \cdot \boldsymbol {U} (t) + \boldsymbol {J} _ {\mathrm {T E Q}} ^ {\mathrm {D}} (t - \Delta T) \tag {3} \\ \end{array}
$$
...
![](images/4ce5ed2da2ebaa7032cdc00613ed6e5992fab99873e930919ea901fbf81d2899.jpg)

![](images/fe547f229e7102531440181f91e8882f9c24fb18c18836f5f92004aafb0a37b3.jpg)  
...
图4中，变压器(含附加电感)的端口电压电流波形可分为4段：1） $0\sim t_{1}$ ，DAB处于基于单移相控制，且输入、输出额定电压相同的正常工作状态[19]；2） $t_1\sim t_{2 - }$ ，出口电压跌落，但DAB仍处于解锁状态 $(t_{2}$ 为换路时刻， $t_{2 - }$ 为换路前一瞬间)；3） $t_2\sim t_3$ ，DAB闭锁，二极管 $\mathrm{D}_5$ 和 $\mathrm{D}_{8}$ 续流；4） $t_3$ 时刻及之后，续流结束， $\mathrm{D}_5\mathrm{-D}_{12}$ 关断，DAB退出运行。

![](images/268bb95509568183407c60d553176f2e027513aa5bca00f060a4329855c7215c.jpg)  
...
![](images/1c78fd154d8200c55fb3f6dfc1c57c8a29483fc01839307d374d3f16acfdc1d5.jpg)

![](images/d2c8a7d572a6fcb352d792163f77c11deccb674af2c9b6479f5c92ec300f07ec.jpg)

![](images/c203d1b970200d3ff0b47cf759bc33f5c1ad36a01238ea38dbf2565c1a107453.jpg)

![](images/99580a4f809449d57641f362a88444a265e2a3899ef61c452a4376b29312739f.jpg)  
(d) $t_3$ 时刻   
图5 DAB模块的故障电流回路  
...
![](images/2c49b654eecb22103a829747386eba08f3236468ead47b4e48e0f71b2aac3af9.jpg)  
...
![](images/f6bc76ec9f25c28bf6b1cc1da8104957e401386e0e75d8341c6024ab2d02172c.jpg)  
(a) 完全闭锁

![](images/13755bedebf20f1d3e21c9564524f8af07ea714f2c1729599cd18894ee8da700.jpg)  
(b) 部分闭锁  
...
式中： $\mathrm{Flag}_i$ 为第 $i$ 个CHB子模块的投入情况，正投入为1，负投入为-1，旁路为0；上标“PBlk”为该参数对应部分闭锁模式。
...
![](images/e7f43b62fe363127022edda5944e2227f99d291141a4c2b666741eeee04a1955.jpg)  
...
![](images/5b612e7fbd162a50bcbe237dc41c22876b93e4b87f417ca729c279d8fd5bdfda.jpg)  
图9 CHB-PET系统示意图  
...
![](images/4728ecb6984408bc6c60292927ee05185c28e10f5e3ea602b7815254c01341e9.jpg)

![](images/85dc4369f961c13c87c2458f2af32a2966b7b7201948aeaa517e75654725493a.jpg)  
(a) 电容电压  
(b) 逐级启动方式下的变压器一次电流

![](images/5b6cf789e8f9ac5d215f9282ec28768e1dff1d3a0bff4738340ac98760ffeda1.jpg)  
(c) 两侧同时启动方式下的变压器一次电流  
图10 系统启动阶段波形
...
在本算例中，假设当 $t = 1.2$ s 时，交流侧发生三相电压暂降，在仿真中设置了 2 种情况：1）交流电压源幅值跌落至额定值的 $50\%$ ，持续时间为 $0.01$ s；2）交流电压源幅值跌落至额定值的 $75\%$ ，持续时间为 $0.05$ s。
...
![](images/aabad918a898f5686ea064669c30541f5a0e7eb3ee730b7c6310bf0425497062.jpg)

![](images/12f43db1a0bc92ba13b4bb5bbaafa23525e0967c1e537cc812f5b942273244c3.jpg)  
(a) 电压  
(b) 电流

![](images/6dafa21907cece7ebfca5c91c1a86cff6629151ef999cfbdb6327a43d4137297.jpg)

![](images/81ce468823b70a968c18eb020f1a329d00d4de7f4cf0e6e35f20e603297395da.jpg)  
(c）电压

![](images/71550aa03e83070c6dd5a920a83f99b827c25a1438772c8caa2fe616aaffe84c.jpg)  
(d) 电压   
(e) 功率  
图11 三相交流电压暂降阶段波形  
...
![](images/7c81208f2d3216ead84752d799e81ab0038e2c4aa94bbd542377fafe69daa26a.jpg)  
(a) 电压

![](images/057d8685c0a5442c4c5ff16315d22f1e081122c461f53b3e96539fe4f3a2e33b.jpg)

![](images/3064dea69ee0464b5594143339ab03c732779b8c3c6aec11d58c90c39a59400e.jpg)  
(b) 电流  
(c）电压   
图12 输出直流侧短路故障波形  
...
![](images/faa33acc2a4dcea253442f871adedbb0cd93ff5e533255abcb2049d70e8dcad7.jpg)  
丁江萍
...
$$
w h e r e U _ {\mathrm {C E Q 1}} ^ {i} (t - \Delta T) = U _ {\mathrm {C 1}} ^ {i} (t - \Delta T) + I _ {\mathrm {C 1}} ^ {i} (t - \Delta T) / G _ {\mathrm {C 1}} ^ {i},
$$

$$
G _ {\mathrm {C} 1} ^ {i} = 2 C _ {1} ^ {i} / \Delta T.
$$
...
![](images/bca5289d3f93fdb421bec7633e1830327608c50e068be4d68c20c41569587e02.jpg)  
...
![](images/2a20cb6fda6ab0aaed4ce10cae89280a8ba6dac27533ddb41714c50c4c644a3b.jpg)

![](images/c1e3826fa2fd8fda240b87ed654479d8ee109bbda43610b8e644a865db38318b.jpg)  
(b) Primary current of transformer in step

![](images/c96eafff629c07e11f987e0179efb49fd7dd84ff3a52974d3487a820213d3395.jpg)  
