...
桥臂中的所有子模块是以首尾依次相连的形式接入电路的，因而可合并为一个戴维南等效电路。设 $j ( j = \mathrm { A } , \mathrm { B } , \mathrm { C } )$ 相 $\cdot ( r { = } \mathrm { P } _ { \mathrm { , } } r { = } \mathrm { N }$ 分别对应每相的上、下桥臂）桥臂的等效电阻 $R _ { \mathrm { e q } } ^ { j r }$ 与等效电压 $U _ { \mathrm { e q } } ^ { j r }$ 分别为：
...
![](images/22271c7446a4d87f59a74730a4febca8d99cc13a979ec016fa53089e8b288fc5.jpg)  
（b）功率阶跃过程
...
［ ］刘耀，吴佳玮，赵小令，等 基于电池储能的 - 系统的建模与仿真［J］. 电力工程技术，2020，39（4）：48-54.  
...
［ ］蔡婉琪 基于模块化多电平换流器的混合储能系统研究［ ］杭州：浙江大学，  
...
ZHANG Guoju,TANG Xisheng,ZHOU Long,et al． Researchon complementary PWM controlled Buck/Boost bi-directionalconverter in supercapacitor energy storage［J］. Proceedings of， ，（）： -
