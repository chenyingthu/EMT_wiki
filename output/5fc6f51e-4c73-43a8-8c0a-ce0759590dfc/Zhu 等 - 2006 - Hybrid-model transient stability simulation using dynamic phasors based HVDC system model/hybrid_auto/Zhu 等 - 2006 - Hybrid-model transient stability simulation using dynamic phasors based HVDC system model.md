...
![](images/d44fb6d1fb5f274f679cd0b9085bc7560c887bc86ed8f5d799cd578fb807c9ab.jpg)  
...
$$
\begin{array}{l} \Delta \dot {I} _ {\mathrm {C}} = \dot {I} _ {\mathrm {C}} - \dot {I} _ {\mathrm {D P}} = Y _ {2 1} \dot {V} _ {\mathrm {G}} + Y _ {2 2} \left[ V _ {\mathrm {r}} e ^ {j \theta_ {\mathrm {r}}} \quad V _ {\mathrm {i}} e ^ {j \theta_ {\mathrm {i}}} \right] ^ {\mathrm {T}} \\ - \left[ \sqrt {2} \dot {I} _ {\mathrm {r} _ {1}} \mathrm {e} ^ {j \left(\theta_ {\mathrm {r}} + \pi / 3\right)} \quad \sqrt {2} \dot {I} _ {\mathrm {i} _ {1}} \mathrm {e} ^ {j \left(\theta_ {\mathrm {i}} + \pi / 3\right)} \right] ^ {\mathrm {T}} = 0 \tag {26} \\ \end{array}
$$
