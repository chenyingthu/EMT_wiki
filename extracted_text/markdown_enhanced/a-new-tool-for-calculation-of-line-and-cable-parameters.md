...
### Keywords
EMTP, line, cable, transients, per-unit-length.
...
$$Z' = R' + j\omega L' \qquad (1)$$
$$Y' = G' + j\omega C' \qquad (2)$$
...
$$\frac{\partial V}{\partial z} = - (R' + j\omega L') I = -Z' I \qquad (3)$$
$$\frac{\partial I}{\partial z} = - (G' + j\omega C') V = -Y' V \qquad (4)$$
