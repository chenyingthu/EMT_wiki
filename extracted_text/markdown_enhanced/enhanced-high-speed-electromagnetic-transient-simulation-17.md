...
$\ast$ Corresponding author. Tel.: +86 01061773744. E-mail address: xujianzhong@ncepu.edu.cn (J. Xu).
...
**Keywords:**
Thévenin equivalent, Backward Euler (BE) method, Modular multilevel converter (MMC), Nearest level control (NLC), MMC-MTdc grid
...
Each phase arm includes $N$ identical SMs and a reactor $L_S$, $I_{ARM}$ indicates the arm current. The SM is the basic building block of
