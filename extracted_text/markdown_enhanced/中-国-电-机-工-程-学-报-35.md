DOI:10.13334/j.0258-8013.pcsee.2012.19.013
...
**图1 补偿法求取 FDNE 的基本概念**
Fig. 1 Basic concept of the compensation method to obtain FDNE
*(图中标注: $I_{\text{eq}}$, $Y_{\text{eq}}$, $-y$, $Y_f$, $a$, $a'$)*
...
*(图中标注: $u_2$, $A_2$, $A_1$, $B_2$, $B_1$, 电磁侧网络, $I$, FDNE2, $u_1 = u_2$, FDNE1)*