...
∗ Corresponding author. Tel.: +86 755 26036003; fax: +86 755 26036001.  
E-mail address: zhuhaojun@vip.sina.com (H. Zhu).
...
$$ x(\tau) = \sum_{k=-\infty}^{\infty} X_k(t) e^{jk\omega_s \tau} \tag{1} $$
