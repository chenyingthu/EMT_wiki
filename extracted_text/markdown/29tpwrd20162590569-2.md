...
$$
i _ { \mathrm { S M } } \left( t \right) = \left\{ \begin{array} { l l } { i _ { L } , } & { \mathrm { ~ i f ~ } S _ { 1 } \mathrm { ~ i s ~ o n ~ a n d ~ } S _ { 2 } \mathrm { ~ i s ~ o f f } } \\ { 0 , } & { \mathrm { ~ i f ~ } S _ { 1 } \mathrm { ~ i s ~ o f f ~ a n d ~ } S _ { 2 } \mathrm { ~ i s ~ o n } . } \end{array} \right.\tag{1}
$$
...
$$
\nu _ { L } ( t ) = L _ { \mathrm { S M } } \frac { d i _ { L } ( t ) } { d t }\tag{2}
$$
...
$$
i _ { L } \left( t \right) = i _ { L } \left( t - \Delta t \right) + \frac { 1 } { L _ { \mathrm { S M } } } \intop _ { t - \Delta t } ^ { t } \nu _ { L } \left( t \right) d t .\tag{3}
$$
...
![](images/b938606c683b6ba0df56dd9cc0a44e991bd0a5570c38077dbc6a2a4f03a7a052.jpg)  
Fig. 2. Submodule equivalent circuits. (a) Submodule inserted. (b) Submodule bypassed. (c) Norton equivalent of a submodule.

$$
i _ { L } \left( t \right) = i _ { L } \left( t - \Delta t \right) + \frac { \Delta t } { L _ { \mathrm { S M } } } \left( \frac { \nu _ { L } \left( t - \Delta t \right) + \nu _ { L } \left( t \right) } { 2 } \right) .\tag{4}
$$

Equation (4) can be rearranged as

$$
i _ { L } \left( t \right) = \frac { \Delta t } { 2 L _ { \mathrm { S M } } } \nu _ { L } \left( t \right) + \left( i _ { L } \left( t - \Delta t \right) + \frac { \Delta t } { 2 L _ { \mathrm { S M } } } \nu _ { L } \left( t - \Delta t \right) \right)\tag{5}
$$

or

$$
i _ { L } \left( t \right) = \frac { \nu _ { L } \left( t \right) } { R _ { L } } + I _ { L H } .\tag{6}
$$
...
$$
I _ { L H } = i _ { L } \left( t - \Delta t \right) + \frac { \nu _ { L } \left( t - \Delta t \right) } { R _ { L } } .\tag{8}
$$
...
$$
\nu _ { L } \left( t \right) = \left\{ \nu _ { \mathrm { a r m } } \left( t \right) - i _ { \mathrm { S M } } \left( t \right) R _ { \mathrm { o n } } , \mathrm { i f ~ S M ~ i n s e r t e d } \right.\tag{9}
$$

Similarly, the voltage across inductor $\nu _ { L } \left( t - \Delta t \right)$ at previous time-step is calculated as follows:

$$
\nu _ { L } \left( t - \Delta t \right) = \left\{ \begin{array} { c } { \nu _ { \mathrm { a r m } } \left( t - \Delta t \right) - i _ { \mathrm { S M } } \left( t - \Delta t \right) R _ { \mathrm { o n } } , } \\ { \mathrm { i f } \mathrm { S M i n s e r t e d } } \\ { \nu _ { \mathrm { a r m } } \left( t - \Delta t \right) - i _ { \mathrm { S M } } \left( t - \Delta t \right) R _ { \mathrm { o f f } } , } \\ { \mathrm { i f } \mathrm { S M \ b y p a s s e d } . } \end{array} \right.\tag{10}
$$
...
![](images/1578e7508a33aed92c11724886e0ef753db0cbec8f832d48748ac74623c31b15.jpg)  
...
$$
i _ { \mathrm { S M } } \left( t \right) = \frac { 1 } { R _ { S M e q } } \nu _ { \mathrm { a r m } } \left( t \right) + I _ { S M H }\tag{11}
$$

where

$$
R _ { S M e q } = \left\{ \begin{array} { l l } { \displaystyle { \frac { R _ { \mathrm { o n } } R _ { L } + R _ { L } R _ { \mathrm { o f f } } + R _ { \mathrm { o f f } } R _ { L } } { R _ { L } + R _ { \mathrm { o f f } } } } , ~ \mathrm { i f ~ S M ~ i n s e r t e d } } \\ { \displaystyle { \frac { R _ { \mathrm { o n } } R _ { L } + R _ { L } R _ { \mathrm { o f f } } + R _ { \mathrm { o f f } } R _ { L } } { R _ { L } + R _ { \mathrm { o n } } } } , ~ \mathrm { i f ~ S M ~ b y p a s s e d } } \end{array} \right.\tag{12}
$$

$$
I _ { S M H } = \left\{ \begin{array} { l } { I _ { L H } \frac { ( R _ { L } / / R _ { \mathrm { o f f } } ) } { R _ { \mathrm { o n } } + ( R _ { L } / / R _ { \mathrm { o f f } } ) } , \mathrm { i f ~ S M ~ i n s e r t e d } } \\ { I _ { L H } \frac { ( R _ { L } / / R _ { \mathrm { o n } } ) } { R _ { \mathrm { o f f } } + ( R _ { L } / / R _ { \mathrm { o n } } ) } , \mathrm { i f ~ S M ~ b y p a s s e d . } } \end{array} \right.\tag{13}
$$
...
![](images/6101a4e3549c166f0cf27d81b533f33189a32d9f1bdbc2f9afb0cdac9d9dae5f.jpg)  
(a)

![](images/3bf0baa9cc735e9b3575b0aa3d15523cb5ef7f9e81c92318694c035a6590cdaa.jpg)  
(b)  
...
$$
\begin{array} { l } { \displaystyle { i _ { \mathrm { S U M } } = \sum _ { i = 1 } ^ { N } i _ { \mathrm { S M } i } } } \\ { \displaystyle { ~ = \sum _ { i = 1 } ^ { N } \frac { 1 } { R _ { S M e q i } } \nu _ { \mathrm { a r m } } \left( t \right) + \sum _ { i = 1 } ^ { N } I _ { S M H i } } } \\ { \displaystyle { = \frac { 1 } { R _ { A R M e q } } \nu _ { \mathrm { a r m } } \left( t \right) + I _ { A R M H } } } \end{array}\tag{14}
$$
...
$$
{ \left[ i _ { d } \atop i _ { q } \right] } = 2 \omega C _ { \mathrm { a r m } } { \left[ \begin{array} { l l } { 0 } & { 1 } \\ { - 1 } & { 0 } \end{array} \right] } { \left[ \begin{array} { l } { \nu _ { d } } \\ { \nu _ { q } } \\ { \nu _ { q } } \end{array} \right] } + 2 C _ { \mathrm { a r m } } { \frac { d } { d t } } { \left[ \begin{array} { l } { \nu _ { d } } \\ { \nu _ { q } } \end{array} \right] } - 2 { \left[ \begin{array} { l } { i _ { u d } } \\ { i _ { u q } } \\ { i _ { u q } } \end{array} \right] }\tag{15}
$$

$$
\left[ \begin{array} { l } { i _ { s d } } \\ { i _ { s q } } \end{array} \right] = \omega C _ { f } \left[ \begin{array} { l l } { 0 } & { 1 } \\ { - 1 } & { 0 } \end{array} \right] \left[ \begin{array} { l } { \nu _ { d } } \\ { \nu _ { q } } \end{array} \right] + C _ { f } \left. \frac { d } { d t } \left[ \begin{array} { l } { \nu _ { d } } \\ { \nu _ { q } } \end{array} \right] + \left[ \begin{array} { l } { i _ { d } } \\ { i _ { q } } \end{array} \right] \right.\tag{16}
$$

$$
\begin{array} { r } { \Big [ \nu _ { s d } \Big ] = \Big [ \begin{array} { c c } { R _ { s } } & { \omega L _ { s } } \\ { - \omega L _ { s } } & { R _ { s } } \end{array} \Big ] \Big [ i _ { s d } \Big ] + L _ { s } \frac { d } { d t } \Big [ i _ { s d } \Big ] + \Big [ \nu _ { d } } \\ { \nu _ { s q } \Big ] } \end{array}\tag{17}
$$

where ω is the fundamental frequency, $R _ { s }$ and $L _ { s }$ are the resistance and leakage inductance of the coupling transformer, $i _ { d , q } ,$ and $\nu _ { d , q }$ are the $d -$ and q-axis converter output currents and voltages, $i _ { u d , u q }$ are the $d -$ and q-axis upper arm currents and $i _ { s d , s q }$ and $\nu _ { s d , s q }$ are the $d -$ and q-axis grid-side currents and voltages. Since the two converter stations are assumed to be symmetric, the variables and parameters are not subscribed by the numbers 1 and 2, used to denote the two different converter stations. Equations (15)-(17) are used by the inner control loop to obtain the $d -$ and q-axis arm current references $i _ { u d }$ and $i _ { u q }$ as follows:

![](images/598219435528a1863fca3b1f21e8876c08e93204212a02b8255a62e766c4556b.jpg)  
Fig. 5. Schematic representation of the CSMMC based back-to-back converter system and control scheme.

$$
\begin{array} { r } { i _ { u d } = \mathrm { P I } \Big ( i _ { s d } ^ { * } - i _ { s d } \Big ) - \frac { 1 } { 2 } \Big ( \Big ( 1 - \omega ^ { 2 } L _ { s } \left( C _ { f } + 2 C _ { \mathrm { a r m } } \right) \Big ) i _ { s d } } \\ { - \omega \Big ( C _ { f } + 2 C _ { \mathrm { a r m } } \Big ) \nu _ { s q } + \omega \Big ( C _ { f } + 2 C _ { \mathrm { a r m } } \Big ) R _ { s } i _ { s q } \Big ) } \end{array}\tag{18}
$$

$$
\begin{array} { r l r } {  { i _ { u q } = \mathrm { P I } \Big ( i _ { s q } ^ { * } - i _ { s q } \Big ) - \frac { 1 } { 2 } \Big ( \Big ( 1 - \omega ^ { 2 } L _ { s } ( C _ { f } + 2 C _ { \mathrm { a r m } } ) \Big ) i _ { s q } } } \\ & { } & { + \omega \Big ( C _ { f } + 2 C _ { \mathrm { a r m } } \Big ) \nu _ { s d } - \omega \Big ( C _ { f } + 2 C _ { \mathrm { a r m } } \Big ) R _ { s } i _ { s d } \Big ) . } \end{array}\tag{19}
$$
...
$$
\boldsymbol { Q } ^ { * } = - \frac { 3 } { 2 } \nu _ { s q } \boldsymbol { i } _ { s d } ^ { * }\tag{20}
$$

$$
\boldsymbol { P } ^ { * } = \frac { 3 } { 2 } \nu _ { s q } \boldsymbol { i } _ { s q } ^ { * }\tag{21}
$$
...
The computational efficiency of the proposed model is compared for the standalone CSMMC. System parameters are summarized in Table I. The selection of the submodule inductance value is a tradeoff between the inductor current ripple and the size of the inductor. The submodule inductance is calculated to ensure the ripple current within the rage of ±10% [9]. The test system was simulated for 2 s duration and for different numbers of submodules per arm ranging from 5 to 20. The simulation time-step used was 20 µs. The corresponding computation times for the proposed model and traditional model are compared in Table II. Results show the significant reduction in the computing time with the proposed model. The results are plotted in Fig. 6 to give more visual comparisons. Results also indicate that the computing time of the traditional model grows at faster rate as the number of submodules increases. This is because with the large number of submodules, solving the large admittance matrix in EMT solver for the traditional model is very time consuming. Hence, the proposed model will be very useful for the CSMMC with larger number of submodules.

TABLE I  
PARAMETERS FOR THE STAND-ALONE CSMMC
<table><tr><td rowspan=1 colspan=1>DC Link Voltage</td><td rowspan=1 colspan=1>Vdc = 3 kV,Ldc=1 mH</td></tr><tr><td rowspan=1 colspan=1> SM Inductance</td><td rowspan=1 colspan=1>LsM=115 mH</td></tr><tr><td rowspan=1 colspan=1>No of SMs per Arm</td><td rowspan=1 colspan=1>varied from 5 to 20</td></tr><tr><td rowspan=1 colspan=1>Arm Capacitance</td><td rowspan=1 colspan=1> $C _ { \mathrm { a r m } } { = } 5 0 ~ \mu \mathrm { F }$ </td></tr><tr><td rowspan=1 colspan=1>Carrier Frequency</td><td rowspan=1 colspan=1>fc = 0.25 kHz</td></tr><tr><td rowspan=1 colspan=1>Load</td><td rowspan=1 colspan=1>fo = 50 Hz,L=3 mH,R=1.9 Ω</td></tr></table>

TABLE II

COMPARISONS OF COMPUTING TIME BETWEEN THE PROPOSED MODEL AND THE TRADITIONAL MODEL
<table><tr><td rowspan=2 colspan=1>Number ofSubmodulesper Arm</td><td rowspan=1 colspan=2>Computing Time (s)</td><td rowspan=2 colspan=1>Speed-upRatio (%)</td></tr><tr><td rowspan=1 colspan=1>TraditionalModel</td><td rowspan=1 colspan=1>ProposedModel</td></tr><tr><td rowspan=1 colspan=1>5</td><td rowspan=1 colspan=1>51</td><td rowspan=1 colspan=1>9.3</td><td rowspan=1 colspan=1>548</td></tr><tr><td rowspan=1 colspan=1>10</td><td rowspan=1 colspan=1>186</td><td rowspan=1 colspan=1>9.8</td><td rowspan=1 colspan=1>1898</td></tr><tr><td rowspan=1 colspan=1>15</td><td rowspan=1 colspan=1>424</td><td rowspan=1 colspan=1>10.3</td><td rowspan=1 colspan=1>4117</td></tr><tr><td rowspan=1 colspan=1>20</td><td rowspan=1 colspan=1>866</td><td rowspan=1 colspan=1>11.1</td><td rowspan=1 colspan=1>7802</td></tr></table>
...
![](images/05af98d9a17247107dba35bd01ade762dd529180ae3af3eef100cab46eeca501.jpg)

![](images/2e5166ec89abce03501994a2d9ce9d49981a6d1394ebf5d9b46a5720eb0f8270.jpg)  
Fig. 6. (a) Comparison of computation time as a function of the number of submodules. (b) Speed-up ratio.

TABLE III  
COMPARISONS OF NUMBER OF NODES OF THE TEST SYSTEM USING THE PROPOSED MODEL AND THE TRADITIONAL MODEL
<table><tr><td rowspan=2 colspan=1>Number ofSubmodulesper Arm</td><td rowspan=1 colspan=2>Number of Nodes</td></tr><tr><td rowspan=1 colspan=1>TraditionalModel</td><td rowspan=1 colspan=1>ProposedModel</td></tr><tr><td rowspan=1 colspan=1>5</td><td rowspan=1 colspan=1>113</td><td rowspan=1 colspan=1>23</td></tr><tr><td rowspan=1 colspan=1>10</td><td rowspan=1 colspan=1>203</td><td rowspan=1 colspan=1>23</td></tr><tr><td rowspan=1 colspan=1>15</td><td rowspan=1 colspan=1>293</td><td rowspan=1 colspan=1>23</td></tr><tr><td rowspan=1 colspan=1>20</td><td rowspan=1 colspan=1>383</td><td rowspan=1 colspan=1>23</td></tr></table>
...
2) Verification of Current Balancing Algorithm: To demonstrate the accuracy of the proposed model in response to the activation/deactivation of the current balancing controller, balancing control is deactivated at t=1 s, and again activated at t=1.1 s. Very good matching between the results of the two models can be seen in Fig. 9. The slight difference between the results of traditional model and proposed model is due the additional snubber circuit used to control the numerical oscillations [30].

![](images/2a9d79011256fdfa3334bc6ddd70849fce8cdcee26a0deeff134558da49c2e92.jpg)  
...
![](images/e09273cf63b22a31e7ab68b413c3bf1c44466e055e280e94ea7a32d4e7186dde.jpg)
...
![](images/a04caaf59f6e05a98a1b451f37a78060847d265e22dfb433820d2cbf578248e8.jpg)  
...
![](images/452acfc7fa3cfc19a07b9f69b4ae441a791d8ccc191625bd9e8c3f2528eef8a3.jpg)  
...
TABLE IV  
PARAMETERS FOR THE BACK-TO-BACK TEST SYTEM
<table><tr><td rowspan=1 colspan=1>GridVoltage/Frequency</td><td rowspan=1 colspan=1> $V _ { s } = 2 3 0 \mathrm { k V ( l i n e \mathrm { - } l i n e \ R M S ) } ,$  $f _ { 0 } = 5 0 \ \mathrm { H z }$ </td></tr><tr><td rowspan=1 colspan=1>CouplingTransformer</td><td rowspan=1 colspan=1>230/11 kV, 100 MVA, L = 0.16 pu</td></tr><tr><td rowspan=1 colspan=1>ConverterParameters</td><td rowspan=1 colspan=1> $N = 1 0 , S = 1 0 0 \mathrm { M V A } , L _ { \mathrm { S M } } = 1 8 1 m \mathrm { H } ,$  $C _ { \mathrm { a r m } } = 1 5 \mu \mathrm { F } , f _ { c } = 0 . 2 5 \mathrm { k H z }$ </td></tr><tr><td rowspan=1 colspan=1>DC-link reactor</td><td rowspan=1 colspan=1> $L _ { \mathrm { d c } } = 2 5 ~ m \mathrm { H }$ </td></tr><tr><td rowspan=1 colspan=1>Filter Capacitance</td><td rowspan=1 colspan=1> $C _ { f } { = } 7 5 \mu \mathrm { F }$ </td></tr></table>
...
![](images/f8c4a0ab750962112a402260a35084ab4d39870dd30fd5365954458db028a9dd.jpg)  
...
![](images/a2fa2615875a75073c6a015adfdd228c7bfe471fb1d094d9124a1f0db41b16d2.jpg)  
...
![](images/8d647db741dd81243d35ce89ed602d09659d1170c20f851dfc4a54392b217e7e.jpg)  
...
![](images/706feef7081dc53c0a00cd4083f1b61710ca48fde04b8446bcc83725ce2d22fd.jpg)  
...
![](images/c498824ccb3e149ff36513d52433d52ae50c0d7d6f7783ad93e1d235ab4ec7a0.jpg)  
...
The DC-side fault studies are very essential for the back-toback converter systems. It is verified in this study that the proposed model of CSMMC is capable of representing the accurate behavior during the dc-side faults without using any additional switching components in the arm level model.
...
![](images/7797320dc7adf27af1d85bef5c1166ccc5e31fc110d1902e66b7e1d22831883c.jpg)
...
![](images/2fbc34118bc54fdfcb6be93eba2ecff1fdff774d0bb1d672fe48819997a25d90.jpg)
