...
![](images/35403a5352a9c211cd01b9ec66da653374c2f8a72e98b321f64dd9b311bcb1f0.jpg)  
...
![](images/28cddbbf192c04891e0e5e046e0481c93a890a4ded20dfa6df3f7822aa2d1bbd.jpg)  
...
$$
\mathbf { I } \left( t \right) = \mathbf { G } \mathbf { U } \left( t \right) + \mathbf { I } _ { n e } \left( t \right) ,\tag{1}
$$
...
$$
{ \bf { I } } _ { n e } \left( t \right) = { \bf { P I } } \left( { t - \Delta t } \right) + { \bf { Q U } } \left( { t - \Delta t } \right) + { \bf { C } } \left( t \right) ,\tag{2}
$$
...
$$
\begin{array} { c } { \displaystyle i _ { k } \left( t \right) = \displaystyle \sum _ { j = 1 } ^ { m } g _ { k j } u _ { j } \left( t \right) + i _ { n e , k } \left( t \right) } \\ { \displaystyle i _ { n e , k } \left( t \right) = \sum _ { j = 1 } ^ { m } p _ { k j } i _ { j } \left( t - \Delta t \right) + \sum _ { j = 1 } ^ { m } q _ { k j } u _ { j } \left( t - \Delta t \right) } \\ { \displaystyle + c _ { k } \left( t \right) } \\ { \displaystyle k = 1 , \cdots , m } \end{array}\tag{3}
$$
...
![](images/df55a589f9dcf5751a13cf7bb8df6c125b225ac1e6447444c9b3da83e5856c02.jpg)  
...
$$
\begin{array} { r } { \dot { \mathbf { x } } = \mathbf { A } \mathbf { x } + \mathbf { B } \mathbf { u } } \\ { \mathbf { y } = \mathbf { C } \mathbf { x } + \mathbf { D } \mathbf { u } } \end{array}\tag{4}
$$
...
$$
\begin{array} { l } { \mathbf { x } = \mathbf { M } \mathbf { z } } \\ { \mathbf { M } \mathbf { K } \mathbf { v } = \mathbf { A } \mathbf { x } + \mathbf { B } \mathbf { u } } \\ { \mathbf { N } = \mathbf { C } \mathbf { M } } \end{array}\tag{5}
$$
...
$$
\begin{array} { l } { \dot { \mathbf { z } } = \mathbf { K } \mathbf { v } } \\ { \mathbf { y } = \mathbf { N } \mathbf { z } + \mathbf { D } \mathbf { u } } \end{array}\tag{6}
$$

Then, threads can be created for the integration of $z _ { i } \in$ $\mathbf { z } \left( i = 1 , \cdots , p \right)$ . The coefficient matrices have the following features: 1) Each row of matrix K contains only one nonzero element. 2) Matrix N contains only 0, 1, and -1. 3) p and q should be minimized under constraints 1) and 2). The benefit of the above computational model transformation is twofold.
...
<table><tr><td>Name</td><td>Equation</td><td> $\overline { { G _ { b } } }$ </td><td> $\overline { { A } }$ </td><td> $\overline { { B } }$ </td></tr><tr><td>Resistor</td><td> $\overline { { R i _ { b } = u _ { b } } }$ </td><td> $\overline { { 1 / R } }$ </td><td>0</td><td>0</td></tr><tr><td>Inductor</td><td> $L p i _ { b } = u _ { b }$ </td><td> $\dot { \Delta t } ( 2 L ) ^ { - 1 }$ </td><td> $G _ { b }$ </td><td></td></tr><tr><td>Capacitor</td><td> $C u _ { b } = i _ { b }$ </td><td> $2 C \dot { \Delta } t ^ { - 1 }$ </td><td> $\mathbf { \nabla } _ { G _ { b } }$ </td><td>-1</td></tr><tr><td>Half-Mutual mutual Induct.</td><td> $M _ { 1 2 } p i _ { b 1 } = u _ { b 2 }$ </td><td> $\Delta t ( 2 M _ { 1 2 } ) ^ { - 1 }$ </td><td> $G _ { b }$ </td><td>1</td></tr><tr><td>Controlled Sources</td><td> $( i _ { c } + i _ { b } ) r = u _ { b }$ </td><td> $1 / r$ </td><td></td><td></td></tr></table>

![](images/c7952db2a8e872478f0542d62d87166b925f1040edbc2bceaf8ed6a76cbf51d7.jpg)  
FIGURE 5: Thread structure of electrical system kernel.

$$
\begin{array} { r l } & { \left[ \begin{array} { l l } { L _ { 1 } } & { L _ { 1 2 } } \\ { L _ { 1 2 } } & { L _ { 2 } } \end{array} \right] \frac { d } { d t } \left[ \begin{array} { l } { i _ { 1 } } \\ { i _ { 2 } } \end{array} \right] + \left[ \begin{array} { l l } { R _ { 1 } } & \\ & { R _ { 2 } } \end{array} \right] \left[ \begin{array} { l } { i _ { 1 } } \\ { i _ { 2 } } \end{array} \right] = \left[ \begin{array} { l } { u _ { 1 } } \\ { u _ { 2 } } \end{array} \right] } \\ & { \mathbf { y } = \left[ \begin{array} { l l } { 1 } & \\ & { 1 } \end{array} \right] \left[ \begin{array} { l } { i _ { 1 } } \\ { i _ { 2 } } \end{array} \right] } \end{array}\tag{7}
$$
...
By properly selecting M, N, and K given in (8), state variables of the basic transformer are redefined as four branch currents $i _ { 1 1 } , i _ { 1 2 } , i _ { 2 1 }$ , and $i _ { 2 2 }$ , which form state variable vector z. The related input variables are selected as branch voltages v1 and v2.

$$
\begin{array}{c} \begin{array} { r l } & { \quad \mathbf { z } = [ \begin{array} { l l l } { i _ { 1 1 } } & { i _ { 1 2 } } & { i _ { 2 1 } } & { i _ { 2 2 } } \end{array} ] ^ { T } } \\ & { \quad \mathbf { v } = [ \begin{array} { l l l } { u _ { 1 } - R _ { 1 } i _ { 1 } } & { u _ { 2 } - R _ { 2 } i _ { 2 } } \end{array} ] ^ { T } } \\ & { \quad \mathbf { K } = [ \begin{array} { l l l } { l _ { 1 1 } ^ { - 1 } } & { - 1 } & { l _ { 2 1 } ^ { - 1 } } \\ { l _ { 1 2 } ^ { - 1 } } & { l _ { 2 2 } ^ { - 1 } } & { 1 } \end{array} ] ^ { T } } \\ & { \quad \quad \mathbf { M } = \mathbf { N } = [ \begin{array} { l l l } { 1 } & { 1 } & { 1 } \\ & { 1 } & { 1 } \end{array} ] } \\ & { \quad \quad \boldsymbol { l } _ { 1 1 } ^ { - 1 } } & { l _ { 1 2 } ^ { - 1 } } \\ & { \quad \quad \boldsymbol { l } _ { 2 1 } ^ { - 1 } } & { l _ { 2 2 } ^ { - 1 } } \end{array} ] = [ \begin{array} { l l } { L _ { 1 1 } } & { L _ { 1 2 } } \\ { L _ { 2 1 } } & { L _ { 2 2 } } \end{array} ] ^ { - 1 }  \end{array}\tag{8}
$$
...
![](images/ac20572ac6bcb1171ec8bd9d5346524b2cb673332dc1d12c6765c88b1c62feb4.jpg)  
...
Algorithm 1 Code automation tool for the electrical system   
kernel   
1: Initialize an empty thread grid with 0 threads $( T h = 0 )$   
2: for Component $( C _ { i } )$ in ComponentList do   
3: Find transformation $( m _ { i } , p _ { i } , \mathbf { M } _ { i } , \mathbf { N _ { i } }$ and Ki) for $C _ { i } ;$   
...
9: Generate codes for solving YU = I (Step 3 in Fig. 2);   
10: Compile
...
![](images/773ae2f6d36fcf124a70ff109466948021620b5f9c8581dea715f6cb3cade961.jpg)  
...
![](images/4683829d08011ef03ca8f2337bfee7bd166bb783f325b880bac7b6e0029a7c0c.jpg)  
FIGURE 8: Thread structure for control system kernel.

![](images/8bb05a2e68505de91987d2c7c83b1d13d4847b574f30340050615e5d7aca697d.jpg)  
...
4: Form n DAG groups $G _ { i } , ( i = 1 , \cdots , n )$ by DAG iso  
morphism judgment;   
...
![](images/b49a8480075b7e12300657939209f46dae15358b9fe589012cce4f9fa6677a97.jpg)  
...
![](images/4b185e2b2173d996e915c7e667512da73e8eedad2f6fb89fb8e1c871fc606c53.jpg)  
FIGURE 11: Case topology part 1: Electrical network.

![](images/7f42278a7475c60f14a78fa86f04ae852c57eb9f84ef7eac86d9fd58b3030a74.jpg)  
...
1) t ∈ [2, 2.5), voltage drop to 20% at phase A of bus 1; and

2) t ∈ [3, inf), radiation changes from 1000 to 600 $W / m ^ { 2 }$
...
<table><tr><td></td><td>CPU</td><td>GPU1</td><td>GPU 2</td></tr><tr><td>Processor</td><td>Intel Xeon E5-2620</td><td>NVIDIAK20x</td><td>NVIDIAP100</td></tr><tr><td>Operating System</td><td>Linux</td><td>Linux</td><td>Linux</td></tr><tr><td>Core Numbers</td><td>12</td><td>2688 CUDA Cores</td><td>3584CUDA Cores</td></tr><tr><td>Core Frequency</td><td>2.0 GHz</td><td>732 MHz</td><td>1.3 GHz</td></tr><tr><td>Memory Size/Memory Frequency</td><td>32 GB /1.6 GHz</td><td>5 GB /5.2 GHz (GDDR5)</td><td>12 GB /1.4 GHz (HBM2)</td></tr></table>

TABLE 3: Computational scale of testing cases
<table><tr><td>Item</td><td>Value</td></tr><tr><td>Electrical system nodes Primitive electrical elements</td><td> $\mathrm { \overline { { 3 + 1 9 2 N _ { e } + 1 1 N _ { c } } } }$   $3 + 4 8 0 \mathbf { N _ { e } } + 1 7 \mathbf { N _ { c } }$ </td></tr><tr><td>Primitive control elements</td><td>78Nc</td></tr><tr><td>Number of layers</td><td>34</td></tr></table>

![](images/9f85109446e78936ff3333992d1f044aea315823500e48f87736981fa37d8bfe.jpg)  
...
Table 5 shows that for cases with large-scale control systems, P3 and P4 on the GPU gained more significant accelerations than those using the P1 and P2 on a CPU.

TABLE 4: Efficiency results of the electrical system
