...
$$
\begin{array} { r } { \dot { \mathbf { x } } = \mathbf { A } _ { k } \mathbf { x } + \mathbf { B } _ { k } \mathbf { u } } \\ { \mathbf { y } = \mathbf { C } _ { k } \mathbf { x } + \mathbf { D } _ { k } \mathbf { u } } \end{array}\tag{1}
$$
...
$$
{ \bf x } _ { t + \Delta t } = \hat { \bf A } _ { k } { \bf x } _ { t } + \hat { \bf B } _ { k } { \bf u } _ { t } + \hat { \bf B } _ { k } { \bf u } _ { t + \Delta t }\tag{2}
$$
...
$$
\begin{array} { r } { \mathbf { x } _ { t + \Delta t } = \hat { \mathbf { A } } _ { k } \mathbf { x } _ { t } + \hat { \mathbf { B } } _ { k } \mathbf { u } _ { t } + \left[ \hat { \mathbf { B } } _ { k _ { i } } \quad \hat { \mathbf { B } } _ { k _ { n } } \right] \left[ \mathbf { u } _ { i _ { t + \Delta t } } \right] } \\ { \mathbf { u } _ { n _ { t + \Delta t } } } \end{array}\tag{3}
$$

$$
\begin{array} { r } { \left[ \begin{array} { l } { \mathbf { y } _ { i _ { t + \Delta t } } } \\ { \mathbf { y } _ { n _ { t + \Delta t } } } \end{array} \right] { = } \left[ \begin{array} { l } { \mathbf { C } _ { k _ { i } } } \\ { \mathbf { C } _ { k _ { n } } } \end{array} \right] \mathbf { x } _ { t + \Delta t } { + } \left[ \begin{array} { l l } { \mathbf { D } _ { k _ { i } } } & { \mathbf { D } _ { k _ { i n } } } \\ { \mathbf { D } _ { k _ { n i } } } & { \mathbf { D } _ { k _ { n n } } } \end{array} \right] \left[ \begin{array} { l } { \mathbf { u } _ { i _ { t + \Delta t } } } \\ { \mathbf { u } _ { n _ { t + \Delta t } } } \end{array} \right] } \end{array}\tag{4}
$$
...
$$
\begin{array} { r l r } & { } & { \mathbf { y } _ { n _ { t + \Delta t } } = \mathbf { C } _ { k _ { n } } \left( \hat { \mathbf { A } } _ { k } \mathbf { x } _ { t } + \hat { \mathbf { B } } _ { k } \mathbf { u } _ { t } + \hat { \mathbf { B } } _ { k _ { i } } \mathbf { u } _ { i _ { t + \Delta t } } \right) + \mathbf { D } _ { k _ { n i } } \mathbf { u } _ { i _ { t + \Delta t } } } \\ & { } & { \qquad + \left( \mathbf { C } _ { k _ { n } } \hat { \mathbf { B } } _ { k _ { n } } + \mathbf { D } _ { k _ { n n } } \right) \mathbf { u } _ { n _ { t + \Delta t } } . \quad ( 5 } \end{array}\tag{}
$$
...
$$
\begin{array} { r } { { \bf y } _ { n _ { t + \Delta t } } = { \bf y } _ { k _ { h i s t } } + { \bf W } _ { k _ { n } } { \bf u } _ { n _ { t + \Delta t } } . } \end{array}\tag{6}
$$
...
When ${ \bf y } _ { n }$ represents current injections (entering a group) and $\mathbf { u } _ { n }$ is for node voltages, then $\mathbf { y } _ { k _ { \mathrm { h i s t } } }$ represents history current sources $\left( \mathbf { i } _ { k _ { \mathrm { h i s t } } } \right)$ and ${ \mathbf W } _ { k _ { n } }$ is an admittance matrix. This is called hereinafter a V-type SSN group and it is a Norton equivalent.
...
$$
\left[ \mathbf { v } _ { n _ { t + \Delta t } } ^ { \mathrm { I } } \right] = \left[ \begin{array} { l } { \mathbf { v } _ { k _ { h i s t } } } \\ { \mathbf { i } _ { k _ { h i s t } } } \end{array} \right] + \left[ \begin{array} { l l } { \mathbf { W } _ { \mathrm { I I } } } & { \mathbf { W } _ { \mathrm { I V } } } \\ { \mathbf { W } _ { \mathrm { V I } } } & { \mathbf { W } _ { \mathrm { V V } } } \end{array} \right] \left[ \begin{array} { l } { \mathbf { i } _ { n _ { t + \Delta t } } ^ { \mathrm { I } } } \\ { \mathbf { v } _ { n _ { t + \Delta t } } ^ { \mathrm { V } } } \end{array} \right]\tag{8}
$$

where the superscripts I and V denote I-type and V-type relations, respectively, and where the notation has been simplified by dropping the subscripts and in ${ \mathbf W } _ { k _ { n } }$ . This equation is referred to as a mixed-type group. It can be straightforwardly transformed into a nodal representation by regrouping all current vectors $( \mathbf { i } _ { n _ { t + \Delta t } } ^ { \mathbf { I } }$ and $\mathbf { i } _ { n _ { t + \Delta t } } ^ { \mathrm { V } } )$ on the left-hand side

$$
\begin{array} { r } { \left[ \mathbf { \dot { i } } _ { n _ { t + \Delta t } } ^ { \mathrm { I } } \right] = \Gamma _ { k _ { n } } \left[ \mathbf { v } _ { k _ { h i s t } } \right] + \mathbf { Y } _ { k _ { n } } \left[ \mathbf { v } _ { n _ { t + \Delta t } } ^ { \mathrm { I } } \right] . } \end{array}\tag{9}
$$

The admittance matrix ${ \bf Y } _ { k _ { r } }$ derived from a group (of any type) is mapped though its nodes and inserted into the global nodal admittance matrix $\mathbf { Y _ { N } }$ of
...
where the subscript denotes MANA matrices (not state-space matrices) and vectors, the vector can hold unknown voltages and currents, and $\mathbf { Y _ { N } }$ becomes a submatrix in . In (8), the variables $\mathbf { v } _ { n _ { t + \Delta t } } ^ { \mathrm { I } }$ and $\mathbf { i } _ { n _ { t + \Delta t } } ^ { \mathrm { I } }$ can be regrouped on the right-hand side and listed in $\mathbf { x } _ { \mathbf { N } }$ XNT with coefficients inserted in equation rows of $\mathbf { A } _ { \mathbf { N } }$ . The history (or known) terms participate in .

It is also noticed that it is not necessary to assume that all groups are using state-space equations. In fact, any given group can also use nodal equations, in which case, these equations can be included directly into (10) or in MANA equations. Moreover, these equations can contain nonlinear devices solved through an iterative process and independently from state-space equations.
...
The steady-state solution is found by replacing the differential operator by Laplace $s = j \omega$ , with being the complex operator and $\omega$ as the steady-state solution frequency in radians per second. Thus, the complex version of (1) for the solution of state variables becomes

$$
\tilde { \mathbf { X } } = ( s \mathbf { I } - \mathbf { A } _ { k } ) ^ { - 1 } \left( \mathbf { B } _ { k _ { i } } \tilde { \mathbf { U } } _ { i } + \mathbf { B } _ { k _ { n } } \tilde { \mathbf { U } } _ { n } \right)\tag{13}
$$

$$
\tilde { \mathbf { Y } } _ { i } = ( \mathbf { C } _ { k _ { i } } \mathbf { \Delta H } \mathbf { B } _ { k _ { i } } + \mathbf { D } _ { k _ { i i } } ) \tilde { \mathbf { U } } _ { i }
$$

$$
+ \left( \mathbf { C } _ { k _ { i } } \mathbf { H } \mathbf { B } _ { k _ { n } } + \mathbf { D } _ { k _ { i n } } \right) \tilde { \mathbf { U } } _ { n }\tag{14}
$$

$$
\begin{array} { r l } & { \tilde { { { \bf Y } } } _ { n } = ( { \bf C } _ { k _ { n } } { \bf H } { \bf B } _ { k _ { i } } + { \bf D } _ { k _ { n i } } ) \tilde { { { \bf U } } } _ { i } } \\ & { ~ + \left( { \bf C } _ { k _ { n } } { \bf H } { \bf B } _ { k _ { n } } + { \bf D } _ { k _ { n n } } \right) \tilde { { { \bf U } } } _ { n } } \end{array}\tag{15}
$$
...
The proposed SSN method provides several advantages over the state-space method. The clustering approach reduces the size and complexity in the automatic generation of state-space equations for each group. The groups can be solved in parallel and the number of precalculated matrix sets for switching topologies can become substantially reduced.

![](images/1fbd90057fc45be8caff95c80b83f8e6d7936944ec932f8f91850c6550140162.jpg)  
Fig. 1. Three-phase system example.

![](images/980a40ded2dbd376e3b98859041bf82b55c0e5a63bff12caabd565a4667f22d5.jpg)  
...
![](images/3f528d73cb2a26862fde03f5d2d0e5614a10e47524ef88640ea5015e8e6ae828.jpg)  
Fig. 3. Switch SW current for the circuit of Fig. 2.

![](images/842e48c1eb0232ad8f3aeda5ca4c3b0e731035d56285a1e1180a3173d5c94888.jpg)  
...
The test consists of the energization of the dc link to the nominal current with the 300-Mvars capacitor being switched on at $1 . 5 ~ \mathrm { s }$ of the simulation interval.
...
![](images/c670ec0cd7d2cb7bf690b0bfc4740ef813f369339a3a36e656eada5c6512224c.jpg)  
Fig. 5. Twelve-pulse HVDC system.

![](images/82a2d1d3af03065a5cadb2dd72374da52b4457e1b42e9d0443074025d35c6529.jpg)  
Fig. 6. DC-link current.

![](images/033c07cf73b5b163ab57bd839e4a0e813c02a149a02e870e15db21cf342f1091.jpg)  
Fig. 7 DC-link current, zoomed interval.

![](images/294bb20e8123229e0ef342e792c5b6bbfd7585615d2d69d27e045da818491c37.jpg)  
Fig. 8 Rectifier ac currents as well as SSN (solid line) and SPS (dashed line) methods.

## D. Real-Time Simulation Results

In addition to the offline simulations presented before, the HVDC system of Fig. 5 and the breaker test setup of Fig. 9 have been tested in real time on a target platform [24], comprising a single 3.2-GHz Xeon i7 Quad-core PC running under the RedHat Linux kernel. Also, these tests are using the SPS implementation of the SSN algorithm.

![](images/92e013b3bfc76a38f1cdb59e3308df4c7d4d51be22ab8f6e4bf405bd8ffa6d01.jpg)  
Fig. 9. Breaker test setup, single-line diagram.

![](images/f86755dbb5da0f86c16c5333bbcd6515684c1041d3d04c4c34fbdc75c967f4dd.jpg)  
...
<table><tr><td rowspan=1 colspan=1>Test case</td><td rowspan=1 colspan=1>SSN time step (us)</td><td rowspan=1 colspan=1>CPUs used</td></tr><tr><td rowspan=1 colspan=1>HVDC</td><td rowspan=1 colspan=1>10</td><td rowspan=1 colspan=1>3</td></tr><tr><td rowspan=1 colspan=1>Breaker test</td><td rowspan=1 colspan=1>21</td><td rowspan=1 colspan=1>1</td></tr></table>

![](images/0e0bf98f2e6a660dcf9957e0a4222aaeffe9fb59c7fd6f5e4d6abbbc23dc4a4e.jpg)  
...
![](images/eb29aed7f8a09effc6234fbaf4688c1326714d31c3e7232405a3352c756d10e4.jpg)  
Fig. 12. Nonlinear flux-current characteristic, transformer magnetization branch model.

![](images/3bd73bea43c5dba3c28111595608cd23a2f958194a342d7716ed160db6449ba3.jpg)  
...
$$
\phi _ { L _ { t } } = K ^ { ( j ) } i _ { L _ { t } } + \phi _ { 0 } ^ { ( j ) }\tag{16}
$$

where $\phi _ { L _ { t } }$ is the nonlinear inductance flux at the time point $t ,$ $i _ { L _ { t } }$ is the inductance current, is the iteration counter, $K ^ { ( j ) }$ is the segment slope at iteration $j ,$ and $\phi _ { 0 } ^ { ( j ) }$ is the segment flux at zero current. Since using voltage unknowns in nodal analysis is required, it can be demonstrated that (16) can be transformed into

$$
i _ { L _ { t } } = \frac { \Delta t } { 2 K ^ { ( j ) } } v _ { L _ { t } } + \frac { 1 } { K ^ { ( j ) } } \left( \phi _ { L _ { h } } - \phi _ { 0 } ^ { ( j ) } \right)\tag{17}
$$
...
![](images/fcae64cbb8c342b0e8d5e44ec106bc33285d185be7409a7472c4ea910e81eaa5.jpg)  
